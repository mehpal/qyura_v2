                            ...
                            <aside class="col-md-6 col-sm-6">
                                ...
                                <div class="clearfix m-t-10">
                                    ...
                                    <p class="col-md-8 col-sm-8">
                                        <input type="text" disabled="" class="form-control" name="quotationId" value="<?php if (!empty($quotationDetail) && $quotationDetail[0]->uniqueId != '') {
    echo $quotationDetail[0]->uniqueId;
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        ...
                                        <select class="selectpicker" name="timeslot" id="timeslot" data-width="100%" >
                                            ...
                                            <?php if($mITimeSloat){
                                                ...
                                                ?>
                                            <option <?php echo $quotationDetail[0]->timeSlotId == $sloat->id ?'selected':'';  ?> value="<?php echo $sloat->id; ?>"><?php echo getDoctorAvailibilitySession($sloat->sessionType); ?>|<?php echo date('h:i A',  strtotime($sloat->startTime)) ; ?>-<?php echo date('h:i A',strtotime($sloat->endTime)) ; ?></option>
                                                <?php
                                                }
                                            } ?>
                                        </select>
                                        <div class="has-error error" id="err_input4" ><?php echo form_error("timeslot"); ?></div>
                                    </div>
                                </article>
                                ...
                                <div class="clearfix m-t-10">
                                    ...
                                    <div class="input-group" style="padding:5px 15px;"  >
                                        <input  class="form-control" placeholder="dd/mm/yyyy" value="<?php if (!empty($quotationDetail) && $quotationDetail[0]->dt != '') {
    echo date('m/d/Y', $quotationDetail[0]->dt);
} else {
    echo 'NA';
} ?>" id="preferedDate" type="text" name="preferedDate" onkeydown="return false;">
                                ...
                                <div class="clearfix m-t-10">
                                    <label class="col-md-4 col-sm-4"> Time</label>
                                    <p class="col-md-8 col-sm-8">
                                    <div class="input-group" style="padding:5px 15px;">

                                        <div class="bootstrap-timepicker input-group " >
                                            <input id="timepicker4" type="text" class="form-control timepicker" value="<?php echo date("h:i a", $quotationDetail[0]->dt); ?>" name="quotationTime" />
                                        </div>
...
<?php 
echo form_radio(array('name' => 'existsDr', 'value' => '1', 'checked' => ($quotationDetail[0]->docRefeId) ? TRUE : FALSE, 'id' => 'drExistsList', 'onclick' => 'showExistsBox(this.value)'));
?> Available Dr.<?php echo form_radio(array('name' => 'existsDr', 'value' => '2', 'checked' => ($quotationDetail[0]->docRefeId == 0) ? TRUE : FALSE, 'onclick' => 'showExistsBox(this.value)','id'=>'drNameInput')); ?>
                                        Not Available Dr.
                                    <label class="error" > <?php echo form_error("existsDr"); ?></label>
                                    </div>
                                </article>

                                <article class="clearfix m-t-10 drText" style="display: <?php echo ($quotationDetail[0]->docRefeId == 0) ? 'block' : 'none' ?>">
                                    <div class="col-md-8 col-sm-8 col-md-offset-4">
                                        <input value="<?php echo $quotationDetail[0]->docName; ?>"  class="form-control" id="drName" type="text"  name="drName" placeholder="Amit Sharma">
                                    </div>
                                    <label class="error" > <?php echo form_error("drName"); ?></label>
                                </article>

                                <article class="clearfix m-t-10 drList"  style="display: <?php echo ($quotationDetail[0]->docRefeId == 0) ? 'none' : 'block' ?>">
                                    <div class="col-md-8 col-sm-8 col-md-offset-4">
                                        <select class="form-control selectpicker" data-width="100%" name="refDoctor" id="refDoctor" required="">
                                            ...
                                            if ($mIDrs) {
                                                ...
                                                foreach ($mIDrs as $mIDr) {
                                                    ?>
                                                    <option <?php echo $quotationDetail[0]->docRefeId == $mIDr->userId ? 'selected' : ''; ?> value="<?php echo $mIDr->userId; ?>"><?php echo $mIDr->name; ?></option>
        <?php
    }
}
?>
                                        ...
                                        <label class="error" > <?php echo form_error("refDoctor"); ?></label>
...
<?php if (isset($quotationPrescription) && !empty($quotationPrescription)) {
    foreach ($quotationPrescription as $key => $val) {
        ?>
                                                ...
                                                <article class="img m-t-10">
                                                    <img src="<?php if ($val->pricription != '') {
                            ...
                            <aside class="col-md-6 col-sm-6">
                                <div class="clearfix m-t-20">
                                    <article class="col-md-2 p-0 pull-right m-r-20">
                                        <img src="<?php if (!empty($quotationDetail) && $quotationDetail[0]->pImg != '') {
    ...
    echo base_url('assets/images/noImage.png');
                                    ...
                                    <article class="col-md-5 text-right pull-right">
                                        <h3><?php if (!empty($quotationDetail) && $quotationDetail[0]->pName != '') {
    echo $quotationDetail[0]->pName;
} else {
    echo 'NA';
} ?></h3>

                                        <p><?php if (!empty($quotationDetail) && $quotationDetail[0]->gender != '') {
                                        echo getGender($quotationDetail[0]->gender);
                                    } else {
                                        echo 'NA';
                                    } ?>  <?php if (!empty($quotationDetail) && $quotationDetail[0]->userAge != '') {
                                        echo isBlank($quotationDetail[0]->userAge);
                                    } else {
                                        echo 'NA';
                                    } ?> Year</p>

                                        <p><?php if (!empty($quotationDetail) && $quotationDetail[0]->contact != '') {
                                ...
                                <div class="clearfix m-t-20">
                                    <article class="col-md-2 p-0 pull-right m-r-20">
                                        <img src="<?php if (!empty($quotationDetail) && $quotationDetail[0]->miImg != '') {
                                    ...
                                    <article class="col-md-5 text-right pull-right">
                                        <h3><?php if (!empty($quotationDetail) && $quotationDetail[0]->miName != '') {
                                        echo $quotationDetail[0]->miName;
                                    } else {
                                        echo 'NA';
                                    } ?></h3>
                                        <p><?php if (!empty($quotationDetail) && $quotationDetail[0]->miNumber != '') {
