<div class="content-page"> 
	...
	<div class="clearfix">
        ...
        <div class="container row " style="width: 600px; margin: 0 auto ; background:whitesmoke;">
            <form  class="cmxform form-horizontal tasi-form avatar-form"  name="editCityForm" method="post"  action="<?php echo site_url(); ?>/master/city_master/editCity" novalidate="novalidate" enctype="multipart/form-data" id="submitForm">
                <?php if (isset($city_value) && !empty($city_value)) { ?>
                        <input type="hidden" name="city_id" value="<?php echo $city_value->city_id; ?>" />
                            ...
                            <article class="clearfix m-t-10">
                                ...
                                <div class="col-md-8  col-sm-8">
                                    <select class="selectpicker form-control" data-width="100%" name="city_stateid" id="stateId" data-size="4" onchange ="fetchCity(this.value)">
                            ...
                            <article class="clearfix m-t-10">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" id="city_name" type="text" name="city_name" placeholder="City Name" value="<?php if($city_value->city_name){ echo $city_value->city_name; }else{ echo set_value("city_name"); } ?>">
                            ...
                            <article class="clearfix m-t-10">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" id="city_center" type="text" name="city_center" placeholder="City Center" value="<?php if($city_value->city_center){ echo $city_value->city_center; }else{ echo set_value("city_center"); } ?>">
                            ...
                            <article class="clearfix">
                                ...
                                <div class="col-md-8  col-sm-8">
                                    <input name="lat" onkeypress="return isNumberKey(event,'err_lat')" class="form-control" type="text" value="<?php if($city_value->city_lat){ echo $city_value->city_lat; }else{ echo set_value("lat"); } ?>"  id="lat" placeholder="Latitude" min="9" max="9"/>
                            ...
                            <article class="clearfix">
                                ...
                                <div class="col-md-8  col-sm-8 ">
                                    <input name="lng" onkeypress="return isNumberKey(event,'err_lng')" type="text" value="<?php if($city_value->city_long){ echo $city_value->city_long; }else{ echo set_value("lng"); } ?>"  id="lng" class="form-control" placeholder="Longitude" min="9" max="9"/>
                                    <label class="error" id="err_lng" > <?php echo form_error("lng"); ?></label>
                                </div>
                            </article>
                        <article class="clearfix m-t-10 m-b-20">
                            <button class="btn btn-success waves-effect waves-light pull-right" type="submit">Upadate</button>
                        </article>
                    <?php } ?>
                </form>
            </div>
