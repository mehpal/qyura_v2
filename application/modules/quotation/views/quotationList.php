                    ...
                    <form name="csvDownload" id="" action="<?php echo site_url('quotation/createQuoteCSV'); ?>" method="post">
                        ...
                        <aside class="col-lg-2 col-md-3 col-sm-3 m-tb-xs-3">
                            <div class="input-group">
                                <input class="form-control searchDate" placeholder="From" id="fromDate" name="fromDate" type="text" onkeydown="return false;">
                        ...
                        <aside class="col-lg-2 col-md-3 col-sm-3 m-tb-xs-3">
                            <div class="input-group">
                                <input class="form-control searchDate" placeholder="To" id="toDate" name="toDate" type="text" onkeydown="return false;">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                            </div>
                        </aside>
                        <p id="date_error"></p>
