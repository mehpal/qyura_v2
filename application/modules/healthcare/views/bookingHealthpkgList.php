<!-- Start right Content here -->
                ...
                <div class="container row">
                    ...
                    <section class="col-md-12 detailbox">
                        ...
                        <article class="row p-b-10">
                            <form name="csvDownload" id="" action="<?php echo site_url('healthcare/createCSVForBookPkg'); ?>" method="post">
    ...
    <?php }
                                ...
                                <aside class="col-md-2 col-sm-2 pull-right">
                                    <button class="btn btn-appointment waves-effect waves-light m-l-10 pull-right" onclick="createCSVForBookPkg()" type="submit">Export</button>
                                </aside>
