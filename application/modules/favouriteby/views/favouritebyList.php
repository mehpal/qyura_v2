 <!-- Start right Content here -->
            ...
            <div class="content">
                <div class="container row">
                    <div class="clearfix">
                        ...
                        <div class="col-md-12">
                            <h3 class="pull-left page-title">Favorited By</h3>
                    ...
                    <section class="col-md-12 detailbox">
                        ...
                        <article class="row p-b-10">
                            <form name="csvDownload" id="" action="<?php echo site_url('favouriteby/createCSV'); ?>" method="post">
                               
                                <aside class="col-md-3 col-sm-3 m-tb-xs-3">
                                    <select class="selectpicker" name="mi_cityId" id="mi_cityId" data-width="100%" >
    ...
    <?php }
                        ...
                        <div class="bg-white">
                            <!-- Table Section Start -->
                           <div id="load_consulting" class="text-center text-success "><image alt="Please wait data is loading" src="<?php echo base_url('assets/images/loader/loader.gif'); ?>" /></div>
