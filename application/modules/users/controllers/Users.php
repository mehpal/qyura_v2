...
//            user insurance
        ...
        if ($this->bf_form_validation->run() === FALSE) {
            ...
            $users_insert = $this->common_model->customInsert($options);
            ...
            for ($i = 1; $i <= $total_test; $i++) {
                ...
                if ($healthInsurance == 1) {
                    ...
                    $user_insuranceId = $this->input->post('userInsurance_insuranceId_' . $i);
                    $user_insuranceNo = $this->input->post('userInsurance_insuranceNo_' . $i);
