                    ...
                    <form>
                        ...
                        <aside class="col-md-3 col-sm-3 m-tb-xs-3">
                            <div class="input-group">
                                <input type="text" onkeydown="return false;" id="date-1" placeholder="From" class="form-control pickDate">
                        ...
                        <aside class="col-md-3 col-sm-3 m-tb-xs-3">
                            <div class="input-group">
                                <input type="text" onkeydown="return false;" id="date-2" placeholder="To" class="form-control pickDate">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                            </div>
                        </aside>
                ...
                <div class="bg-white">
                    ...
                    <article class="text-center clearfix border-third">
                        <ul class="nav nav-tabs">
                            <li id="li_consulting" class="active col-md-6 col-xs-6">
                                <a href="#consulting" data-toggle="tab">Consulting</a>
                            </li>
                            <li id="li_diagnostic" class="col-md-6 col-xs-6 b-left">
