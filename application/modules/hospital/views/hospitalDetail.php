...
<!--                                                        <input id="uploadBtn" type="file" class="upload" />-->
                                                    <input type="hidden" style="display:none;" class="no-display file_action_url"  name="file_action_url" value="<?php echo site_url('hospital/editUploadImage'); ?>">
    ...
    echo "active";
                                    ...
                                    <li class=" <?php if (isset($active) && $active == 'membership') {
    echo "active";
} ?>">
    ...
    foreach ($membership_datail as $membership) {
        ?>
                                                                                                                    ...
                                                                                                                    <article class="clearfix m-b-10">
                                                                                                                        ...
                                                                                                                        <p class="col-md-8 col-sm-7"><?php echo $membership->miMembership_quantity; ?> <?php echo $membership->facilities_name; ?> <?php if ($membership->facilities_id == 2 || $membership->facilities_id == 4) {
