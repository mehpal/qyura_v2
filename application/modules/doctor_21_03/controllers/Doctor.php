...
//        }
    ...
    function changePassword(){
        ...
        $this->bf_form_validation->set_rules("password","Password", 'required|xss_clean|matches[confirm]');
        $this->bf_form_validation->set_rules("confirm","Confirm Password", 'required|xss_clean');
        ...
        if ($this->bf_form_validation->run() == FALSE) {
            ...
            if ($user_updated) {
                $responce =  array('status'=>1,'msg'=>"Password change successfully",'url' =>"doctor/doctorDetails/$doctorAjaxId");
            }else
            {
    ...
    function editExperience(){
        ...
        for($j = 1; $j <= $total_edit_exp; $j++){
            ...
            $this->bf_form_validation->set_rules("speciality_edit$j[$j]","Specility $j", 'required|xss_clean');
    ...
    function changeDetailDoctor(){
        ...
        if ($this->bf_form_validation->run($this) == FALSE) {
            ...
            $users_email = $this->input->post('users_email');
            $doctors_address = $this->input->post('doctor_address');
            $pre_number = $this->input->post('preNumber');
            $midNumber = $this->input->post('midNumber');
            $doctors_phn = $this->input->post('doctors_phn');
            $finalNumber = '';
