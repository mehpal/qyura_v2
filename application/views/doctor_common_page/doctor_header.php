...
<head>
    ...
    <link type="text/css" href="<?php echo base_url();?>assets/vendor/js-scroll/style/scroll-2.css" rel="stylesheet" media="all" />
                ...
                <div class="container row">
                    <div class="clearfix">
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            <li class="dropdown">
                                <a aria-expanded="true" class="dropdown-toggle profile" data-toggle="dropdown" href=""><img alt="User-Img" class="img-circle" src="<?php echo base_url();?>assets/doctorsImages/<?php echo $this->session->userdata("ses_doc_image");?>"> <?php echo $this->session->userdata("ses_doc_name");?>	
