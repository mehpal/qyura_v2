...
class Hospital extends MY_Controller {
    ...
    function hospitalAwards($hospitalId) {
        ...
        if ($dataAwards) {
            foreach ($dataAwards as $key => $val) {
                $showAwards .='<li>' . $val->hospitalAwards_awardsName . ' ' . $val->hospitalAwards_awardYear . '</li>';
            }
        } else {
    ...
    function detailAwards($hospitalId) {
        ...
        <div class="col-md-8 col-sm-8 col-xs-8">
           <input type="text" class="form-control" name="hospitalAwards_awardsName" id=' . $val->hospitalAwards_id . ' value="' . $val->hospitalAwards_awardsName . '" placeholder="FICCI Healthcare " />
            ...
            <input type="text" class="form-control" name="hospital_awardsyear" id=year' . $val->hospitalAwards_id . ' value="' . $val->hospitalAwards_awardYear . '" placeholder="2016" />
    ...
    function addHospitalAwards() {
        ...
        $awardData = array('hospitalAwards_awardsName' => $hospitalAwards_awardsName, 'hospitalAwards_awardYear' => $hospitalAwards_awardYear, 'hospitalAwards_hospitalId' => $hospitalId);
    ...
    function editHospitalAwards() {
        ...
        $updatedData = array('hospitalAwards_awardsName' => $hospitalAwards_awardsName, 'hospitalAwards_awardYear' => $hospitalAwards_awardYear);
            ...
            if ($hospital_usersId) {
                ...
                if ($_POST['bloodbank_chk'] == 1) {
                    ...
                    $bloodBankDetail = array(
                        ...
                        'creationTime' => strtotime(date("Y-m-d H:i:s")),
                        'bloodBank_phn' => rtrim($finalBloodbnkNumber, '|'),
                ...
                if ($_POST['pharmacy_chk'] == 1) {
                    ...
                    $pharmacyDetail = array(
                        ...
                        'creationTime' => strtotime(date("Y-m-d H:i:s")),
                        'pharmacy_phn' => rtrim($finalPharmacyNumber, '|'),
                ...
                if ($_POST['ambulance_chk'] == 1) {
                    ...
                    $ambulanceDetail = array(
                        ...
                        'creationTime' => strtotime(date("Y-m-d H:i:s")),
                        'ambulance_phn' => rtrim($finalAmbulanceNumber, '|'),
