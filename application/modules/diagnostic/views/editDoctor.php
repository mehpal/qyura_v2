                    ...
                    <form class="cmxform form-horizontal tasi-form avatar-form-doctor-edit" id="submitFormDoctorEdit" method="post" action="<?php echo site_url('hospital/saveDoctor'); ?>" name="doctorForm" enctype="multipart/form-data">
                        ...
                        <section class="clearfix ">
                            <div class="col-md-12 m-t-20 m-b-20">
                                ...
                                <a class="btn btn-danger waves-effect pull-right" type="button" href="<?php echo base_url().'/index.php/diagnostic/detailDiagnostic/'.$diagnosticData[0]->diagnostic_id.'/doctor'; ?>">Reset</a>
                        ...
                        <input type="hidden" name="daignoUserIdDoctor" value="<?php if(isset($diagnosticData[0]->diagnostic_usersId)){ echo $diagnosticData[0]->diagnostic_usersId; }?>" id="daignoUserIdDoctor" />
