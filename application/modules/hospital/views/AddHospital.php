...
?>
                            ...
                            <article class="clearfix m-t-10">
                                ...
                                <div class="col-md-8  col-sm-8">
                                    <textarea class="form-control" name="hospital_aboutUs" id="hospital_aboutUs" maxlength="255"  value=""><?php echo set_value('hospital_aboutUs'); ?></textarea>
                                        ...
                                        <article class="clearfix m-t-10">
                                            ...
                                            <div class="col-md-8 col-sm-8">
                                                ...
                                                <aside class="row">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-10 m-t-xs-10" id="multiBloodbnkPhoneNumber">
                                                        <input type="text" class="form-control" name="bloodBank_phn[]" id="bloodBank_phn1" maxlength="8" onkeypress="return isNumberKey(event)" />
                                        ...
                                        <article class="clearfix m-t-10">
                                            ...
                                            <div class="col-md-8 col-sm-8">
                                                <aside class="row">
                                                    ...
                                                    <div class="col-md-5 col-sm-4 col-xs-10 m-t-xs-10" id="phoneAmbulance">
                                                        <input type="text" class="form-control" name="ambulance_phn[]" id="ambulance_phn1" maxlength="8" onkeypress="return isNumberKey(event)"/>
