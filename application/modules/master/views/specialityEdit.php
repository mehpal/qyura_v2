                ...
                <?php if (isset($specialityList) && !empty($specialityList)) {
                    foreach ($specialityList as $key => $val) { ?>
                        ...
                        <article class="form-group m-lr-0" id="crop-avatar">
                            ...
                            <?php if(!empty($val->specialities_img)){  ?><img height="80px;" width="80px;" src="<?php echo base_url()?>assets/specialityImages/3x/<?php echo $val->specialities_img; ?>" class="img-responsive"><?php } else { ?>
