...
<!-- comman END-->
                                ...
                                <aside class="clearfix m-t-20">
                                    <article class="form-group m-lr-0 m-rl-o">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            ...
                                            <input class="form-control" id="patient_email" name="input9" type="email"  aria-required="true" placeholder="Test@gmail.com" onblur="getpatientdetails()">
                        ...
                        <section class="clearfix ">
                            <div class="col-md-12 m-t-20 m-b-20">
                                <input class="btn btn-success waves-effect waves-light pull-right m-r-20" type="submit" value="Submit" onclick="return check_time()">
                            </div>
                        </section>
                    </form>
                </div>
