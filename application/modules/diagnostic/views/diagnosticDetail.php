                ...
                <div class="bg-white">
                    ...
                    <section class="col-md-12">
                        <aside class="clearfix m-bg-pic">
                            ...
                            if (isset($diagnosticData) && !empty($diagnosticData[0]->diagnostic_background_img)): echo base_url() . 'assets/diagnosticsImage/' . $diagnosticData[0]->diagnostic_background_img;
                            else : echo base_url() . 'assets/default-images/Diagnostic_Centre.png';
                            endif;
                            ?>')">                                      
                                <div class="bg-picture-overlay"></div>
...
=======
                                    ...
                                    <div class='pro-img' id="crop-avatar-upload">
>>>>>>> e3a3a790219d4ef500a153b393d2761eee86f0d6
...
<!--                                                        <input id="uploadBtn" type="file" class="upload" />-->
                        ...
                        <article class="text-center clearfix m-t-50">
                            <ul class="nav nav-tab nav-setting">
                                ...
                                <li class="<?php
                                if (isset($active) && $active == 'collectionCenter') {
                                    echo "active";
                                }
                                ?>">
                                ...
                                <li class="<?php
                                if (isset($active) && ( $active == 'timeslot' OR $active == 'timeSlot' )) {
                                    echo "active";
                                }
                                ?>">
    ...
    <?php } else { ?>
                                                        ...
                                                        <article class="clearfix m-b-10">
                                                            ...
                                                            <p class="col-md-8 col-sm-8 t-xs-left"><?php if (isset($diagnosticData[0]->diagnostic_docatId)) {
                                                                        echo $diagnosticData[0]->diagnostic_docatId;
                                                                    } ?></p>
                                                        </article> 
    ...
    ?>
                                                            ...
                                                            <?php foreach ($allStates as $key => $val) { ?>
                                                                            <option <?php if ($diagnosticData[0]->diagnostic_stateId == $val->state_id):echo"selected";
    ...
    <?php foreach ($allCities as $key => $val) { ?>
                                                                            <option <?php if ($diagnosticData[0]->diagnostic_cityId == $val->city_id):echo"selected";
...
<<<<<<< HEAD
    ...
    if (!empty($diagnosticData) && isset($diagnosticData) && $diagnosticData[0]->isManual == 1) {
    ...
    ?>  name="isManual" value="1" id="isManual" onclick="IsAdrManual(this.value)">
                                                                                                                                ...
                                                                                                                                <aside class="radio radio-info radio-inline">
                                                                                                                                    <input type="radio" <?php
    if (!empty($diagnosticData) && isset($diagnosticData) && $diagnosticData[0]->isManual == 0) {
        echo 'checked="checked" ';
    }
...
>>>>>>> e3a3a790219d4ef500a153b393d2761eee86f0d6
    ...
    ?>"/>
                                                            ...
                                                            <article class="clearfix">
                                                                <div class="col-sm-8 col-sm-offset-4">
                                                                    <aside class="row">
                                                                        <div class="col-sm-6">
                                                                            <input name="lat" class="form-control" required="" type="text"   id="lat" <?php
    if (!empty($diagnosticData) && isset($diagnosticData) && $diagnosticData[0]->isManual == 0) {
        echo '';
    }
    ?> value="<?php echo $diagnosticData[0]->diagnostic_lat; ?>" onchange="latChack(this.value)" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                                                        ...
                                                                        <div class="col-sm-6 m-t-xs-10">
                                                                            <input name="lng" class="form-control" required="" type="text"  id="lng" <?php
    if (!empty($diagnosticData) && $diagnosticData[0]->isManual == 0) {
        echo '';
    }
...
>>>>>>> e3a3a790219d4ef500a153b393d2761eee86f0d6
    ...
    <!--                                                                    <input class="form-control" id="diagnostic_aboutUs" name="diagnostic_aboutUs" type="text" required="" value="" />-->
                                                                    <textarea value="" id="diagnostic_aboutUs" name="diagnostic_aboutUs" class="form-control"><?php
                                                                                if (isset($diagnosticData) && !empty($diagnosticData)): echo $diagnosticData[0]->diagnostic_aboutUs;
                                                                                endif;
                                                                                ?></textarea>
                                                            ...
                                                            <article class="clearfix">
                                                                ...
                                                                <div class="col-md-8 col-xs-3">
                                                                    <aside class="checkbox checkbox-success m-t-5">
                                                                        ...
                                                                        <input type="checkbox" id="bloodbankbtn" name="bloodbank_chk" value="1" <?php if (isset($diagnosticData[0]->diagnostic_hasBloodbank) && $diagnosticData[0]->diagnostic_hasBloodbank == 1) {
                                                                                    echo 'checked="checked" ';
                                                                                } ?> >
                                                                        <label>
...
<<<<<<< HEAD
    ...
    <?php // dump($diagnosticData);  ?>
                                                            ...
                                                            <section id="bloodbankdetail" style="<?php if (isset($diagnosticData[0]->diagnostic_hasBloodbank) && $diagnosticData[0]->diagnostic_hasBloodbank == 1) {
        echo 'display:block';
    } else {
        echo 'display:none';
    } ?>">
                                                                <input type="hidden" name="isBloodBankOutsource"          value="<?php if (isset($diagnosticData[0]->diagnostic_isBloodBankOutsource) && $diagnosticData[0]->diagnostic_isBloodBankOutsource != '') {
        echo $diagnosticData[0]->diagnostic_isBloodBankOutsource;
    } ?>" id="isBloodBankOutsource" >

                                                                <article class="clearfix m-b-10">
                                                                    <label for="cemail" class="control-label col-md-4 col-sm-4">Name :</label>
                                                                    <div class="col-md-8 col-sm-8">
                                                                        <input class="form-control" name="bloodBank_name" id="bloodBank_name" type="text" value="<?php if (isset($diagnosticData[0]->bloodBank_name)) {
        echo $diagnosticData[0]->bloodBank_name;
    } ?>">
    ...
    <?php } ?>
                                ...
                                <!--                                                        <input id="uploadBtn" type="file" class="upload" />-->
                                                                                ...
                                                                                <div class="col-md-8 col-sm-8">
                                                                                    <aside class="row">
                                                                                        ...
                                                                                        <div class="col-xs-10 m-t-xs-10">
                                                                                            <input type="teL" class="form-control" name="bloodBank_phn" id="bloodBank_phn" value ="<?php if (isset($diagnosticData[0]->bloodBank_phn) && $diagnosticData[0]->bloodBank_phn != '') {
                                                                                                echo $diagnosticData[0]->bloodBank_phn;
                                                                            ...
                                                                            <article class="clearfix">
                                                                                ...
                                                                                <div class="col-md-8 col-xs-3">
                                                                                    <aside class="checkbox checkbox-success m-t-5">
                                                                                        <input type="checkbox" id="pharmacybtn" name="pharmacy_chk" value="1" <?php if (isset($diagnosticData[0]->diagnostic_hasPharmacy) && $diagnosticData[0]->diagnostic_hasPharmacy == 1) {
                                                                                                echo 'checked="checked" ';
                                                                                            } ?>  >
                                                                                        <label>
                                                                            ...
                                                                            <article class="clearfix">
                                                                                ...
                                                                                <div class="col-md-8 col-xs-3">
                                                                                    <aside class="checkbox checkbox-success m-t-5">
                                                                                        <input type="checkbox" id="ambulancebtn" name="ambulance_chk" value="1" <?php if (isset($diagnosticData[0]->ambulance_phn) && $diagnosticData[0]->ambulance_phn != '') {
                                                                                                echo 'checked="checked" ';
                                                                                            } ?> >
                                                                                        <label>
                                                                            ...
                                                                            <section id="ambulancedetail" style="<?php if (isset($diagnosticData[0]->ambulance_phn) && $diagnosticData[0]->ambulance_phn != '') {
                                                                                                echo 'display:block';
                                                                                            } else {
                                                                                                echo 'display:none';
                                                                                            } ?>">
                                                                                ...
                                                                                <article class="clearfix m-b-10">
                                                                                    <label for="cemail" class="control-label col-md-4 col-sm-4">Name :</label>
                                                                                    <div class="col-md-8 col-sm-8">
                                                                                        <input class="form-control" name="ambulance_name" id="ambulance_name" type="text" value="<?php if (isset($diagnosticData[0]->ambulance_name)) {
                                                                                                echo $diagnosticData[0]->ambulance_name;
                                                                                            } ?>">
...
>>>>>>> e3a3a790219d4ef500a153b393d2761eee86f0d6
                                                                                                        ...
                                                                                                        <div class="col-xs-10 m-t-xs-10">
                                                                                                            <input type="text" class="form-control" name="ambulance_phn" id="ambulance_phn" value ="<?php if (isset($diagnosticData[0]->ambulance_phn) && $diagnosticData[0]->ambulance_phn != '') {
        echo $diagnosticData[0]->ambulance_phn;
                                                                                            ...
                                                                                            <article class="clearfix">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xs-3">
                                                                                                    <aside class="checkbox checkbox-success m-t-5">
                                                                                                        <input type="checkbox" id="docOnBoard" name="docOnBoard" value="1" <?php if ($diagnosticData[0]->docOnBoard == 1) {
                                                                                                    echo "checked";
                                                                                                } ?> >
                                                                                                        <label>
                                                                                            ...
                                                                                            <article class="clearfix">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xs-3">
                                                                                                    <aside class="checkbox checkbox-success m-t-5">
                                                                                                        <input type="checkbox" id="isEmergency" name="isEmergency" value="1" <?php if ($diagnosticData[0]->diagnostic_isEmergency == 1) {
                                                                                                                    echo "checked";
                                                                                                                } ?> />
                                                                                                        <label>
                                                                                            ...
                                                                                            <article class="clearfix">
                                                                                                ...
                                                                                                <div class="col-md-8 col-xs-3">
                                                                                                    <aside class="checkbox checkbox-success m-t-5">
                                                                                                        <input type="checkbox" id="availibility_24_7" name="availibility_24_7" value="1" <?php if ($diagnosticData[0]->diagnostic_availibility_24_7 == 1) {
                                                                                                                    echo "checked";
                                                                                                                } ?> />
                                                                                                        <label>
                                                                                            ...
                                                                                            <input name="user_tables_id" id="user_tables_id" type="hidden" value="<?php
                                                                                                                if (isset($diagnosticData[0]->diagnostic_usersId)) {
    ...
    ?>" id="diagnostic">
                                                                            ...
                                                                            <!--Specialities Starts -->
                                                                            <section class="tab-pane fade in" id="specialities" <?php
                                                                            if (isset($active) && $active == 'specialities') {
                                                                                echo "active";
                                                                            }
                                                                            ?>">
                                                                            ...
                                                                            if ($diagnosticData[0]->diagnostic_specialityNameFormate == 1) {
                                                                                echo "checked";
                                                                            }
                                                                            ?> >
                                                                            ...
                                                                            if ($diagnosticData[0]->diagnostic_specialityNameFormate == 0) {
                                                                                echo "checked";
                                                                            }
                                                                            ?>>
    ...
    <?php if (isset($timeSlot) && !empty($timeSlot)): ?>
                                                                                    ...
                                                                                    <form method="post" name="timeSlotForm" id="timeSlotForm" action="<?php echo site_url('diagnostic/updateTimeSlot'); ?>">
                                                                                        ...
                                                                                        if (isset($diagnosticData[0]->diagnostic_id)) {
...
>>>>>>> e3a3a790219d4ef500a153b393d2761eee86f0d6
                                                                                                            ...
                                                                                                            <option value="">Select Membership</option>
                                                                                                               <?php if (isset($membership_plan) && $membership_plan) {
                                                                                                                   foreach ($membership_plan as $membership) {
                                                                                                                       ?>
                                                                                                                    <option value="<?php echo $membership->membership_id; ?>" <?php if ($diagnosticData[0]->diagnostic_mbrTyp == $membership->membership_id) {
                                                                                                                           echo "selected";
    ...
    ?>" onblur="checkEmailFormat()" required="" readonly="">
                                                                                                    <label class="error" style="display:none;" id="error-users_email"> please enter Email id Properly</label>
    ...
    ?>"/>
                                                                                            <article class="clearfix m-b-10 ">
                                                                                                ...
                                                                                                <div class="col-md-8 col-sm-8">
                                                                                                    <input type="teL" class="form-control" name="users_mobile" id="users_mobile" placeholder="9837000123" maxlength="10" onkeypress="return isNumberKey(event)" value="<?php
    if (isset($diagnosticData[0]->users_mobile)) {
...
<!-- /Change Logo -->
<!-- END wrapper -->
>>>>>>> 1e94641f538d5a9746d9a5ee8818b72dbc031c0a
