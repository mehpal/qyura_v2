                                            ...
                                            <form name="doctorDetailForm" action="#" id="doctorDetailForm" method="post">
                                                ...
                                                <article class="clearfix m-lr-0" >
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        ...
                                                        <label class="error" id="err_docatId" > <?php echo form_error("docatId"); ?></label>
                                                    </div>
                                                </article>
                                                <article class="clearfix m-lr-0" >
                                    ...
                                    <form name="changePasswordForm" action="#" id="changePasswordForm" method="post">
                                        ...
                                        <section class="clearfix ">
                                            <div class="m-t-20 m-b-20">
                                                <button type="submit" class="btn btn-appointment waves-effect waves-light m-r-20">Update</button>
                                            </div>
                                        </section>
                                    </form>
                                </section>
                                                                ...
                                                                <div id="formDabba" class="col-sm-12">
                                                                    <form  class="cmxform form-horizontal tasi-form avatar-form" id="timeForm" name="addDoctorSlot" method="post" action="#" novalidate="novalidate">
                                                                        ...
                                                                        <article class="clearfix m-t-10">
                                                                            ...
                                                                            <span id="err_docTimeTable_stayAt" class="error"><?php echo form_error("docTimeTable_stayAt"); ?></span>
                                                                        </article>
                                                                        ...
                                                                        <article class="clearfix m-t-10" id="div_docTimeTable_MItype">
                                                                            ...
                                                                            <div class="">
                                                                                ...
                                                                                <span id="err_docTimeTable_MItype" class="error"><?php echo form_error("docTimeTable_MItype"); ?></spanl>
                                                                            </div>
                                                                        ...
                                                                        <article class="clearfix m-t-10" id="div_Mi_name">
                                                                        ...
                                                                        <article class="clearfix m-t-10" id="div_address">
                                                                            ...
                                                                            <aside class="row clearfix m-t-10">
                                                                                ...
                                                                                <div class="col-md-6 col-sm-6">
                                                                                    ...
                                                                                    <span id="err_countryId" class="error"><?php echo form_error("countryId"); ?></span>
                                                                                </div>
                                                                            ...
                                                                            <aside class="row clearfix m-t-10">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <input name="lat" class="form-control" required="" type="text" value=""  id="mi_lat" placeholder="Latitude" onchange="latChack(this.value)" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength="10"/>
                                                                                    <span id="err_lat" class="error" > <?php echo form_error("lat"); ?></span>
                                                                                    <label class="error" style="display:none;" id="error-lat">Please enter the correct format for latitude</label>
                                                                                </div>

                                                                                <div class="col-sm-6">
                                                                                    <input name="lng" required="" type="text" value=""  id="mi_lng" class="form-control" placeholder="Longitude" onChange="lngChack(this.value)" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength="10"/>
                                                                                    <label id="err_lng" class="error" > <?php echo form_error("lng"); ?></label>
                                                                                    <span class="error" style="display:none;" id="error-lng"> Please enter the correct format for longitude</span>
                                                                                </div>
                                                                        ...
                                                                        <article class="clearfix  m-t-10">
                                                                            ...
                                                                            <aside class="row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <div class="bootstrap-timepicker input-group w-full">
                                                                                    <input name="closeingHour" required="" type="text" value="<?php echo set_value('closeingHour'); ?>"  id="closeingHour"  class="form-control timepicker" placeholder="closing Hour"  maxlength="9"/>
