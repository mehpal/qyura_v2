...
CASE 
 ...
 AS `rating` ')
                ...
                ->join("qyura_diagnostic", "qyura_diagnostic.diagnostic_usersId = qyura_doctors.doctors_parentId ", "INNER")
                ...
                ->where(array('doctors_deleted' => 0,'qyura_doctors.status' => 1, 'doctors_parentId' => $diagonsticUserId, 'qyura_specialities.specialities_id' => $specialityId,'qyura_specialities.status' => 1,'qyura_specialities.type' => 1))
