               ...
               <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="active"><a href="<?php echo base_url();?>index.php/ambulance">All Ambulance Providers</a></li>
                        ...
                        <article class="row p-b-10">
                            <form>
                                ...
                                <aside class="col-md-3 col-sm-3 m-tb-xs-3">
                                    <select type="text" name="pharmacy_cityId" class="selectpicker" data-width="100%"  placeholder="Search" id="pharmacy_cityId" data-size="4" />
                                   <!-- <option>Delhi</option>
