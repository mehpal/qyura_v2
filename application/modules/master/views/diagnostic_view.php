                ...
                <aside class="bg-white">
                    <div class="nicescroll mxh-400" style="overflow: hidden;" tabindex="5000">
                        <div class="col-sm-12 p-t-20 p-b-20">
                            <?php if(isset($diagnostic_list) && $diagnostic_list != NULL){ 
                                foreach ($diagnostic_list as $diagnostic){ ?>
                                <article class="clearfix degrees membership-plan">
                                    <aside class="col-lg-9 col-sm-9 col-xs-9">
                                        <?php echo $diagnostic->diagnostic_name; ?>
                                    </aside>
                                    <aside class="col-lg-3 col-sm-3 col-xs-3">
                                        <a class="btn btn-success waves-effect waves-light m-b-5" href="<?php echo site_url('master/mi_master/editDiagnosticView/' . $diagnostic->diagnostic_id); ?>"><i class="fa fa-pencil"></i></a>
                                        <button onclick="enableFn('master/mi_master', 'diagnosticPublish', '<?php echo $diagnostic->diagnostic_id ?>','<?php echo $diagnostic->status; ?>')" title='<?php if($diagnostic->status == 2){ echo "Publish"; }else{ echo "Unpublish"; } ?> Hospital' type="button" class="btn btn-success waves-effect waves-light m-b-5"><i class="fa fa-thumbs-<?php if($diagnostic->status == 3){ echo "up"; }else{ echo "down danger"; } ?>"></i></button>
                                    </aside>
                                </article>
                            <?php } } ?>
                        </div>
                ...
                <div class="bg-white">
                    <aside class="clearfix">
                        ...
                        <figure class="text-center">
                         ...
                         Add Category 
                        <div class="col-sm-12">
                            <form name="diagnosticForm" action="#" id="diagnosticForm" method="post">
                                <article class="clearfix m-t-10">
                                    <label for="cname" class="control-label col-md-4 col-sm-4">Name:</label>
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control m-t-10" id="diagnostic_name" type="text" name="diagnostic_name" placeholder="">
                                ...
                                <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <select class="form-control selectpicker" data-width="100%" name="diagnostic_countryId" id="diagnostic_countryId" onchange ="fetchState(this.value)">
                                            <option value="">Select Country</option>
                                            <?php if (isset($country_list) && !empty($country_list)) {
                                                foreach ($country_list as $key => $val) { ?>
                                                    <option <?php echo set_select('diagnostic_countryId', $val->country_id); ?>  value="<?php echo $val->country_id; ?>"><?php echo $val->country; ?></option>
                                            <?php } } ?>
                                        </select>
                                ...
                                <article class="clearfix">
                                    <div class="col-md-8  col-sm-8 col-sm-offset-4">
                                        <select class="selectpicker form-control" data-width="100%" name="diagnostic_stateId" id="stateId" data-size="4" onchange ="fetchCity(this.value)">
                                ...
                                <article class="clearfix">
                                    <div class="col-md-8  col-sm-8 col-sm-offset-4">
                                        <select class="form-control selectpicker" data-width="100%" name="diagnostic_cityId" id="cityId" data-size="4">
                                ...
                                <article class="clearfix m-t-10">
                                    <div class="col-md-8  col-sm-8 col-sm-offset-4">
                                        <input type="text" class="form-control" id="hospital_zip" name="diagnostic_zip" placeholder="Zipcode" onkeypress="return isNumberKey(event)" maxlength="6" value="<?php echo set_value('diagnostic_zip'); ?>" />
                                        <label class="error" id="err_diagnostic_zip" > <?php echo form_error("diagnostic_zip"); ?></label>
                                    </div>
                                </article>
                                <article class="clearfix m-t-10">
                                    <div class="col-md-8  col-sm-8 col-sm-offset-4">
                                        <input type="text" class="form-control geocomplete" id="geocomplete1" name="diagnostic_address" placeholder="Address" value="<?php echo set_value('diagnostic_address'); ?>" />
