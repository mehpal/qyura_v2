...
<label class="error" > <?php echo form_error("hospital_address"); ?></label>
                                                            ...
                                                            <article class="clearfix m-t-10">
                                                                ...
                                                                <div class="col-md-8  col-sm-8">
                                                                    <textarea value="" maxlength="255" id="hospital_aboutUs" name="hospital_aboutUs" class="form-control"><?php echo $hospitalData[0]->hospital_aboutUs;  ?></textarea>
                                                                       ...
                                                                       <div class="col-md-8 col-sm-8">
                                                                           ...
                                                                           <aside class="row">
                                                                             ...
                                                                             <div class="col-md-4 col-sm-4 col-xs-10 m-t-xs-10">
                                                                               ...
                                                                               <div class="col-md-5 col-sm-4 col-xs-10 m-t-xs-10">
                                                                                   <input type="teL" class="form-control" name="bloodBank_phn[]" id="bloodBank_phn<?php echo ($i+1);?>" value ="<?php if(isset($more_bloodbank[2]) && $more_bloodbank[2] != ''){ echo $more_bloodbank[2]; } ?>" onkeypress="return isNumberKey(event)" maxlength="8" />
                                                                               </div>
                                                                            ...
                                                                            <input type="text" onkeypress="return isNumberKey(event)" onblur="checkNumber('midNumber',1)" maxlength="5"  id="bloodMidNumber" name="bloodMidNumber[]" class="form-control" requird>
                                                                               ...
                                                                               <div class="col-md-5 col-sm-4 col-xs-10 m-t-xs-10">
                                                                                   <input type="teL" class="form-control" name="bloodBank_phn[]" id="bloodBank_phn1" value =""  onkeypress="return isNumberKey(event)" maxlength="8"/>
                                                                               </div>
                                                                       ...
                                                                       <div class="col-md-8 col-sm-8">
                                                                           ...
                                                                           <aside class="row">
                                                                            ...
                                                                            <input type="text" onkeypress="return isNumberKey(event)" onblur="checkNumber('midNumber',1)" maxlength="5" value="<?php if(isset($more_ambulance[1]) && $more_ambulance[1] != ''){ echo $more_ambulance[1]; } ?>"  id="ambulanceMidNumber" name="ambulanceMidNumber[]" class="form-control" requird>
                                                                               ...
                                                                               <div class="col-md-5 col-sm-4 col-xs-10 m-t-xs-10">
                                                                                   <input type="text" class="form-control" name="ambulance_phn[]" id="ambulance_phn<?php echo ($i+1);?>" value ="<?php if(isset($more_ambulance[2]) && $more_ambulance[2] != ''){ echo $more_ambulance[2]; } ?>" onkeypress="return isNumberKey(event)" onkeypress="return isNumberKey(event)" maxlength="8" />
                                                                               </div>
                                                                            ...
                                                                            <?php $more_ambulance = ''; } } else {?>
                                                                              ...
                                                                              <div class="col-md-4 col-sm-4 col-xs-10 m-t-xs-10">
                                                                               ...
                                                                               <div class="col-md-5 col-sm-4 col-xs-10 m-t-xs-10">
                                                                                   <input type="teL" class="form-control" name="ambulance_phn[]" id="ambulance_phn1" value ="" onkeypress="return isNumberKey(event)" maxlength="8"/>
                                                                               </div>
                                                                        ...
                                                                        <div class="col-md-9 col-sm-8">
                                                                            <aside class="row">
                                                                                <div class="col-md-10 col-sm-10 col-xs-10">
                                                                                    <input type="text" class="form-control" name="hospitalAwards_awardsName" id="hospitalAwards_awardsName" placeholder="" />
