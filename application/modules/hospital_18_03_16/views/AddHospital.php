                            ...
                            <!--    <div>
                                ...
                                <aside class="clearfix m-t-20 p-b-20">
                                    <article class="clearfix m-t-10">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input type="email" class="form-control" id="users_email" name="users_email" placeholder="abc@gmail.com" onblur="return checkUserExistence(this.value),checkEmailFormat()"  value="<?php echo set_value('users_email'); ?>" />
