<div class="content-page"> 
	...
	<div class="clearfix">
            <div class="col-md-12 m-t-10">
                <h3 class="pull-left page-title m-l-10">Edit Speciality</h3>
                ...
                <?php if (isset($specialityList) && !empty($specialityList)) {
                    foreach ($specialityList as $key => $val) { ?>
                        ...
                        <article class="clearfix m-t-10">
                            ...
                            <div class="">
                                <textarea class="form-control m-t-5" id="keywords" type="text" name="keywords" required=""><?php echo $val->speciality_tag; ?></textarea>
