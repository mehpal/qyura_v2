                            ...
                            <aside class="col-md-8">
                                <div class="clearfix m-t-20 p-b-20">
                                    ...
                                    <article class="clearfix m-t-10">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <select class="form-control select2" data-width="100%" name="pharmacyType">
                                ...
                                <div class="col-md-8 col-sm-8" data-target="#modal" data-toggle="modal">
                                   ...
                                   <img src="<?php echo base_url() ?>assets/default-images/Pharmacy-logo.png"  class="image-preview-show"/> 
                                    ...
                                    <article class="clearfix m-t-10">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <select class="form-control select2" data-width="100%" name="pharmacy_countryId" id="pharmacy_countryId">
                                    ...
                                    <article class="clearfix">
                                        <div class="col-md-8 col-sm-8 col-sm-offset-4">
                                            <select class="form-control select2" data-width="100%" name="pharmacy_stateId" Id="pharmacy_stateId" data-size="4" onchange ="fetchCity(this.value)">
                                    ...
                                    <article class="clearfix">
                                        <div class="col-sm-8 col-sm-offset-4">
                                            <select class="form-control select2" data-width="100%" name="pharmacy_cityId" id="pharmacy_cityId" data-size="4">
...
<!--                                    <article class="clearfix">
                                    ...
                                    <article class="clearfix m-t-10">
                                        ...
                                        <div class="col-sm-8">
                                            <aside class="row">
                                                <div class="col-sm-6">
                                                    <input name="lat" class="form-control" type="text" value="<?php echo set_value('lat'); ?>"  id="lat" placeholder="Latitude" <?php
                                                ...
                                                <div class="col-sm-6 m-t-xs-10">
                                                    ...
                                                    <input name="lng" class="form-control" type="text" value="<?php echo set_value('lng'); ?>"  id="lng" placeholder="Longitude" <?php
                                                    if (set_radio('isManual', '0') == 'checked="checked"') {
                                                        echo 'readonly';
                                                    }
                                                    ?>/>
                                    ...
                                    <article class="clearfix m-t-10">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <select class="form-control select2" data-width="100%" name="pharmacy_mmbrTyp" id="pharmacy_mmbrTyp">
