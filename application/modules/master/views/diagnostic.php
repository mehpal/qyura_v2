            ...
            <section class="col-md-5 detailbox">
                <div class="bg-white">
                    <aside class="clearfix">
                        ...
                        <!-- Add Specialities -->
                        <div class="col-sm-12">
                            <form  class="cmxform form-horizontal tasi-form avatar-form" id="submitForm" name="addDiagnosticForm" method="post" action="#" novalidate="novalidate" enctype="multipart/form-data" onsubmit="return imageValidate()">
