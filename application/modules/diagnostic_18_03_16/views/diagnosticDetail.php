                                                        ...
                                                        <section id="detail">
                                                            ...
                                                            <article class="clearfix m-b-10">
                                                                ...
                                                                <aside class="col-md-8 col-sm-8 t-xs-left">
                                                                     <?php 
                                                                     if(!empty($diagnosticData[0]->diagnostic_phn) && isset($diagnosticData[0]->diagnostic_phn)){
                                                    ...
                                                    <label class="error" > <?php echo form_error("diagnostic_countryId"); ?></label>
                                                          ...
                                                          <article class="clearfix">
                                                                  <div class="col-sm-8 col-sm-offset-4">
                                                                            <select class="selectpicker form-control" data-width="100%" name="diagnostic_stateId" onchange ="fetchCity(this.value)" id="diagnostic_stateId">                                                                                                                            </select>
                                                                 ...
                                                                 <div class="col-md-8 col-sm-8">
                                                                    ...
                                                                    <aside class="row">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12 m-t-xs-10">
                                                                            <input type="text" class="form-control" name="diagnostic_phn[]" id="diagnostic_phn<?php echo ($i+1);?>" placeholder="9837000123" value="<?php if(isset($moreExpolde[1])){ echo $moreExpolde[1];}?>" maxlength="10" onkeypress="return isNumberKey(event)"/>
                                                                        </div>
                                                                    </aside>
                                                                   <!-- </br> -->
                                                                       <?php $moreExpolde ='';}?>
...
<!--                                                 </article> -->
						...
						<input type="hidden" id="user_tables_id" name="user_table_id" value="<?php if(!empty($diagnosticData)): echo $diagnosticData[0]->diagnostic_usersId; endif;?>"/>
                                                ...
                                                <input type="teL" class="form-control" name="users_mobile" id="users_mobile" placeholder="9837000123" maxlength="10" onkeypress="return isNumberKey(event)" value="<?php if(isset($diagnosticData[0]->users_mobile)){ echo $diagnosticData[0]->users_mobile; } ?>"/>
                                                                   <label class="error" id="error-users_mobile" style="display:none;"> Enter Mobile Number</label>                                         <!--<p class="m-t-10">* If it is landline, include Std code with number </p> -->   
                                                    </div>
                                                </article>
                                                <article class="clearfix m-b-10">
