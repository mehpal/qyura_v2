                            ...
                            <div class="bg-white clearfix">
                                ...
                                <aside class="clearfix m-t-20">
                                    ...
                                    <article class="form-group m-lr-0">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input class="form-control" id="users_mobile" name="input10" type="text"  aria-required="true" placeholder="Mobile Number" onkeypress="return isNumberKey(event)" onblur="checkMobile()">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <aside class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <select class="form-control selectpicker" id="countryId" name="input13" data-size="4" data-width="100%" >
                                                        <option value="1">India</option>
                                                    </select>
                                                    <div class="has-error " id="err_input13" ><?php echo form_error("input13"); ?></div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 m-t-xs-10">
                                                    <select class="form-control selectpicker" data-width="100%" name="input14" Id="stateId" data-size="4" onchange ="fetchCity(this.value)" >
                                    ...
                                    <article class="form-group m-lr-0 m-t-xs-10">
                                        <div class="col-md-8 col-md-offset-4 col-sm-8 col-sm-offset-4">
                                            <aside class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 m-t-xs-10">
                                                    <input type="text" class="form-control" id="zip" name="input16" placeholder="Zip" onkeypress="return isNumberKey(event)" maxlength="6"/>
