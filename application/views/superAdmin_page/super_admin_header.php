...
<!--                        <li class="has_sub">
			...
			<li class="has_sub">
				...
				<li class="<?php  if($this->router->fetch_class() == 'sponserhealthtip' && $this->router->fetch_method() == 'bookedsponser'):echo"boldTitle  active";endif;?>"><a class="<?php if($this->router->fetch_class() == 'sponserhealthtip' && $this->router->fetch_method() == 'bookedsponser'):echo"boldTitle  active";endif;?>" href="<?php echo base_url();?>index.php/sponserhealthtip/bookedsponser">Healthtip Bookings</a></li>
                        ...
                        <li class="has_sub">
                            <a class="waves-effect <?php if($this->router->fetch_class() == 'master' || $this->router->fetch_class() == 'city_master' || $this->router->fetch_class() == 'mi_master' || $this->router->fetch_class() == 'healthcategory' || $this->router->fetch_class() == 'membership'):echo"boldTitle  active";endif;?>" href="#"><i class="fa fa-gift"></i> <span>Master</span><span class="pull-right"><i class="md md-add"></i></span></a>
                            <ul class="list-unstyled">
