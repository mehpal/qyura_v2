...
class MY_Loader extends MX_Loader {
    ...
    function super_admin_template($template_name, $vars = array(), $page_script='')    {
     
        $this->view('superAdmin_page/super_admin_header', $vars);
        $this->view($template_name, $vars);
        $this->view('superAdmin_page/super_admin_footer', $vars);
        if(!empty($page_script)):
        $this->view($page_script,$vars);
        endif;
    }
	function mi_template($template_name, $vars = array(), $page_script='')    {
     
        $this->view('MI_common_page/mi_header', $vars);
        $this->view($template_name, $vars);
        $this->view('MI_common_page/mi_footer', $vars);
        if(!empty($page_script)):
        $this->view($page_script,$vars);
        endif;
    }
     function doc_template($template_name, $vars = array(), $page_script='')    {
     
        $this->view('doctor_common_page/doctor_header', $vars);
        $this->view($template_name, $vars);
        $this->view('doctor_common_page/doctor_footer', $vars);
        if(!empty($page_script)):
        $this->view($page_script,$vars);
        endif;
    }
