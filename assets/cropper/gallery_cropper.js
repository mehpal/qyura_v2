(function (factory) {
  ...
  CropAvatar.prototype = {
    ...
    ajaxUpload: function () {
      var url = this.$container.find('#file_action_url_gallery').val();
    ...
    submitDone: function (data) {
      ...
      if ($.isPlainObject(data) && data.state === 200) {
          // this.$container.find('.text-success').html(data.message);
           ...
           // $("#defaultloader").hide();
           var loadUrl = this.$container.find('#load_url_gallery').val();
           this.$container.find('#display_gallery').load(loadUrl,function () {
           });
