                        ...
                        <div class="bg-white mi-form-section">
                            ...
                            <div class="clearfix m-t-20 p-b-20">
                                ...
                                <article class="clearfix m-t-10 ">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control disabled" id="packageId" name="packageId" type="disabled" aria-required="true" value="<?php echo $editHealthcareData[0]->healthpkgId; ?>" readonly>
                                 ...
                                 <article class="clearfix m-t-10">
                                     ...
                                     <div class="col-md-8 col-sm-8">
                                         <div class="input-group">
                                             <input class="form-control pickDate" id="date-5" type="text" name="enterDate" placeholder="Date To" onkeydown="return false;">
                                ...
                                <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="bestPrice" type="text" name="bestPrice" required="" onkeypress="return isNumberKey(event)" value="<?php echo $editHealthcareData[0]->bp; ?>" onkeyup="getDiscount(bestPrice.value, discountPercent.value)">
                                ...
                                <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="discountPercent" type="text" name="discountPercent" required="" maxlength="3" minlength="1" onkeypress="return isNumberKey(event)" onkeyup="getDiscount(bestPrice.value, discountPercent.value)" value="<?php echo $editHealthcareData[0]->percent; ?>">
                                ...
                                <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="discountPrice" type="text" name="discountPrice" required="" onkeypress="return isNumberKey(event)" value="<?php echo $editHealthcareData[0]->price; ?>">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        ...
                                        <aside class="row clone">
                                            ...
                                            $i++;       }
                                                ...
                                                <input type="text" class="form-control" name="testIncluded[]" id="hospitalServices_serviceName1" maxlength="200" />
