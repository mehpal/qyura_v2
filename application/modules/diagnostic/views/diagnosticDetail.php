               ...
               <div class="col-md-6">
                  ...
                  <section id="detail">
                     ...
                     <section id="newDetail" style="display:none;">
                        <form name="diagnosticForm" id="updateForm" action="<?php echo site_url('diagnostic/saveDetailDiagnostic/' . $formId); ?>" method="post">
...
=======
    ...
    <!-- /Change Logo -->
    <!-- END wrapper -->
>>>>>>> c403867df084b52b9c66e30cdde080e8194c60a2
