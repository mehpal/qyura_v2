...
//      $('#multiPreNumber'+j).selectpicker('refresh');
    ...
    function countserviceName() {
        ...
        $('#serviceName').val(m);
        $('#multiserviceName').append('<article class="clearfix m-t-10"><aside class="col-sm-10"><input type=text class=form-control name=hospitalServices_serviceName[] placeholder="Give Your Service Name" maxlength="30" id=hospitalServices_serviceName' + m + ' /></aside><aside class="col-sm-2 text-right"><a class=add pull-right onclick="removeServiceName(' + m + ')" href=javascript:void(0) id=btn-service' + m + '><i class="fa fa-minus-circle fa-2x m-t-5 label-plus" ></i></a></aside></article>');
    }
