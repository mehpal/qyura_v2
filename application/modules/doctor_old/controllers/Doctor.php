...
//            $doctors_service = $this->input->post('doctors_service');
//            for($m=0; $m < count($doctors_service); $m++){
//                if($doctors_service[$m] != ''){
//                    $insert_rec = array(
//                        'doctorServices_doctorId' => $doctorsProfileId, 
//                        'doctorServices_serviceName' => $doctors_service[$m], 
//                        'creationTime' => date("d-m-Y H:i:s"),
//                    );
//                    $dayOptions = array
//                        (
//                        'data' => $insert_rec,
