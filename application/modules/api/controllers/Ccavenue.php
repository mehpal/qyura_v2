...
//            $remark = isset($_POST['remark']) ? $this->input->post('remark') : '';
        ...
        $preferedDate = isset($_POST['preferedDate']) ? $this->input->post('preferedDate') : '1462818600';
        $preferedTimeId = isset($_POST['preferedTimeId']) ? $this->input->post('preferedTimeId') : '8'; //SessionId of slots
        $userId = isset($_POST['userId']) ? $this->input->post('userId') : '11';
        $memberId = isset($_POST['memberId']) ? $this->input->post('memberId') : 0;
        ...
        $parentId = isset($_POST['parentId']) ? $this->input->post('parentId') : 7;
    ...
    function ccavenue_response() {
        ...
        for ($i = 0; $i < $dataSize; $i++) {
            ...
            if($i==10) $totalAmount = $information[1];
        }
