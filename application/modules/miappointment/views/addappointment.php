        ...
        <div class="content">
            <div class="container row">
                ...
                <div style="display:show;" id="consultDiv">
                    ...
                    <form class="cmxform form-horizontal tasi-form" id="setData" method="post" action="<?php echo site_url(); ?>/miappointment/addAppointmentSave" onsubmit="return check_validaton()">
                        <!-- Left Section Start -->
...
<!--                                    <article class="form-group m-lr-0">
                                    ...
                                    <div id="diagnosticSection" style="display: none">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <div class="input-group">
                                                <input class="form-control pickDate" id="date-5" type="text" onkeydown="return false;" name="input7" />
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <div class="bootstrap-timepicker input-group w-full">
                                                <input id="timepicker5" type="text" class="form-control timepicker" name="input37" value="<?php echo date("H:i"); ?>" />
                                                <div class="has-error " id="err_input37" ><?php echo form_error("input37"); ?></div>
                                            </div>
                                        </div>
                                    </article>
                                        <div id="diagnosticClon_1">
                                            ...
                                            <article class="form-group m-lr-0">
                                                ...
                                                <div class="col-md-8 col-sm-8">
                                                    <input class="form-control " type="text" id="input30_1" name="input30_1"   >
                                ...
                                <aside class="clearfix m-t-20">
                                    <article class="form-group m-lr-0 m-rl-o">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            ...
                                            <input class="form-control" id="patient_email" name="input14" type="email"  aria-required="true" onblur="getpatientdetails()">
                                    ...
                                    <article class="form-group m-lr-0" id="p_unqId" style="display: none">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input class="form-control" id="unqId" name="input16" type="text" aria-required="true" readonly="">
                                    ...
                                    <article class="form-group m-lr-0">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input class="form-control" id="users_username" name="input17" type="text"  aria-required="true" >
...
<?php } ?>
                                    ...
                                    <article class="form-group m-lr-0 m-t-xs-10">
                                        <div class="col-md-8 col-md-offset-4 col-sm-8 col-sm-offset-4">
                                            <input type="text" class="form-control" id="address" name="input21"/>
                                ...
                                <aside class="clearfix m-t-20">
                                    <article class="form-group m-lr-0">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input type="text" class="form-control" id="input22" name="input22" onblur="calculateamount()"/>
                                    ...
                                    <article class="form-group m-lr-0">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input type="text" class="form-control" name="input24" id="input24" onblur="calculateamount()">
                                    ...
                                    <article class="form-group m-lr-0">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input type="text" class="form-control" id="input25" name="input25"  readonly=""/>
