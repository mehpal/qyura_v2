                    ...
                    <div class="bg-white">
                        ...
                        <section class="col-md-12">
                            <aside class="clearfix m-bg-pic">
                                <div class="bg-picture text-center" style="background-image:url('<?php if (isset($hospitalData[0]->hospital_background_img) && !empty($hospitalData[0]->hospital_background_img)): echo base_url() . 'assets/hospitalsImages/' . $hospitalData[0]->hospital_background_img;
...
<?php } ?>
                                        ...
                                        <h4> <?php if (isset($hospitalData[0]->hospital_address)) {
    ...
    echo "active";
                                    ...
                                    <li class="<?php if (isset($active) && $active == 'timeslot') {
    echo "active";
} ?>">
...
<?php if ($hospitalData[0]->hosTypeId != '') {
    echo $hospitalData[0]->hosType;
                                                        ...
                                                        <article class="clearfix m-b-10">
                                                            ...
                                                            <p class="col-md-8 col-sm-8 t-xs-left"><?php if (isset($hospitalData[0]->hospital_address)) {
    echo $hospitalData[0]->hospital_address;
} ?> </p>
                                                        </article>
...
<?php } else { ?>
                                                        ...
                                                        <article class="clearfix m-b-10">
                                                            ...
                                                            <p class="col-md-8  col-sm-8 text-right t-xs-left"> <?php if (isset($hospitalData[0]->hospital_cntPrsn)) {
                                                        ...
                                                        <article class="clearfix m-b-10">
                                                            ...
                                                            <p class="col-md-8 col-sm-8 t-xs-left"><?php if (isset($hospitalData[0]->hospital_dsgn)) {
                                                        ...
                                                        <article class="clearfix m-b-10">
                                                            ...
                                                            <p class="col-md-8 col-sm-8 t-xs-left"><?php if (isset($hospitalData[0]->docatId)) {
                                                        ...
                                                        <article class="clearfix m-b-10">
                                                            ...
                                                            <p class="col-md-8 col-sm-8 t-xs-left"><?php if (isset($hospitalData[0]->hospital_aboutUs)) {
...
<aside class="clearfix p-5">
    ...
    <a style="display:none;" onclick="updateInstruction()" class="btn btn-success waves-effect waves-light m-b-5 p-abs " data-toggle="modal" id="instructionUpdate">Update</a>
                                                            ...
                                                            <!--Specialities Starts -->
                                                            <section class="tab-pane fade in <?php if (isset($active) && $active == 'specialities') {
    echo "active";
} ?>" id="specialities">
                                                                ...
                                                                <article class="clearfix">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <aside class="radio radio-info radio-inline">
                                                                            <input <?php echo set_radio('specialityNameFormate', '1', TRUE); ?> type="radio"  name="specialityNameFormate" value="1" id="specialityNameFormate" onclick="setSpecialityNameFormate(this.value)" <?php if ($hospitalData[0]->specialityNameFormate == 1) {
    echo "checked";
} ?> >
                                                                            <label for="inlineRadio1"> General Name</label>
                                                                        </aside>
                                                                        <aside class="radio radio-info radio-inline">
                                                                            <input <?php echo set_radio('specialityNameFormate', '0'); ?> type="radio" name="specialityNameFormate" value="0" id="specialityNameFormate" onclick="setSpecialityNameFormate(this.value)" <?php if ($hospitalData[0]->specialityNameFormate == 0) {
    echo "checked";
} ?>>
...
<?php if (!empty($gallerys)) {
    ...
    <?php }
                                                            ...
                                                            <section class="tab-pane fade in <?php if (isset($active) && $active == 'timeSlot') {
    echo "active";
} ?>" id="timeslot">
<?php if (isset($timeSlot) && !empty($timeSlot)): ?>
                                                                    ...
                                                                    <form method="post" name="timeSlotForm" id="timeSlotForm" action="<?php echo site_url('hospital/updateTimeSlot'); ?>">
                                                                        ...
                                                                        <input type="hidden" name="mi_user_id" value="<?php if (isset($hospitalData[0]->hospital_usersId)) {
        echo $hospitalData[0]->hospital_usersId;
    } ?>" id="mi_user_id" />

                                                                        <input type="hidden" name="mi_id" value="<?php if (isset($hospitalData[0]->hospital_id)) {
...
<?php if (!empty($allCountry)):
    foreach ($allCountry as $country):
        ?>
                                                                                    <option value="<?php echo $country->country_id; ?>" <?php if ($hospitalData[0]->hospital_countryId == $country->country_id):echo"selected";
...
<?php foreach ($allStates as $key => $val) { ?>
                                                                                <option <?php if ($hospitalData[0]->hospital_stateId == $val->state_id):echo"selected";
...
<?php foreach ($allCities as $key => $val) { ?>
                                                                                <option <?php if ($hospitalData[0]->hospital_cityId == $val->city_id):echo"selected";
...
<?php } ?>
                                                                ...
                                                                <article class="clearfix">
                                                                    <div class="col-sm-offset-4 col-sm-8">
                                                                        <input type="text" class="form-control" id="hospital_zip" name="hospital_zip" placeholder="" maxlength="6" onkeypress="return isNumberKey(event)" value="<?php if (isset($hospitalData[0]->hospital_zip)) {
                               ...
                               >>>>>>> 6a0a96bb5fb9cab3e08aa74f6dd102ed3d30395c
                                                                ...
                                                                <article class="clearfix m-t-10">
                                                                    <div class="col-sm-8 col-sm-offset-4">
                                                                        <input class="form-control geocomplete" id="geocomplete1" name="hospital_address" type="text" value="<?php if (isset($hospitalData[0]->hospital_address)) {
    echo $hospitalData[0]->hospital_address;
} ?>" >
                                                                ...
                                                                <article class="clearfix m-t-10">
                                                                    <div class="col-sm-8 col-sm-offset-4">
                                                                        <aside class="row">
                                                                            <div class="col-sm-6">
                                                                                <input class="form-control" name="lat" type="text"   <?php if (!empty($hospitalData) && $hospitalData[0]->isManual == 0) {
    echo 'readonly="readonly" ';
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <input class="form-control" name="lng" type="text" <?php if (!empty($hospitalData) && $hospitalData[0]->isManual == 0) {
    echo 'readonly="readonly" ';
                                                                        ...
                                                                        <div id="multuple_phone_load">
                                                                            <aside class="row cllone">
                                                                                <div class="col-xs-10 m-t-xs-10">
                                                                                    <input type="text" class="form-control" name="hospital_phn" onkeypress="return isNumberKey(event)" id="hospital_phn" value="<?php if (isset($hospitalData[0]->hospital_phn) && $hospitalData[0]->hospital_phn != '') {
    echo $hospitalData[0]->hospital_phn;
                                                                ...
                                                                <section id="bloodbankdetail" style="display:none">
                                                                    <article class="clearfix m-b-10">
                                                                        <label for="cemail" class="control-label col-md-4 col-sm-4">Name :</label>
                                                                        <div class="col-md-8 col-sm-8">
                                                                            <input class="form-control" name="bloodBank_name" id="bloodBank_name" type="text" value="<?php if (isset($hospitalData[0]->bloodBank_name)) {
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <article class="clearfix m-b-10 ">
                                                                                    ...
                                                                                    <div class="col-md-8 col-sm-8">
                                                                                        <aside class="row">
                                                                                            ...
                                                                                            <div class="col-xs-10 m-t-xs-10">
                                                                                                <input type="teL" class="form-control" name="bloodBank_phn" id="bloodBank_phn" value ="<?php if (isset($hospitalData[0]->bloodBank_phn) && $hospitalData[0]->bloodBank_phn != '') {
                                                                                ...
                                                                                <article class="clearfix">
                                                                                    ...
                                                                                    <div class="col-md-8 col-xs-3">
                                                                                        <aside class="checkbox checkbox-success m-t-5">
                                                                                            <input type="checkbox" id="pharmacybtn" name="pharmacy_chk" value="1" <?php if ($hospitalData[0]->hasPharmacy == 1) {
                                                                                    echo "checked";
                                                                                } ?>>
                                                                                            <label>
                                                                                            </label>
                                                                                ...
                                                                                <!--   <section id="pharmacydetail" style="display:none">
                                                                                   ...
                                                                                   <label for="cemail" class="control-label col-md-4 col-sm-4">Phone Numbers :</label>
                                                                                   <div class="col-md-8 col-sm-8">
<?php /*  if($hospitalData[0]->pharmacy_phn != ''){
...
<?php // }  ?>
                                                                                ...
                                                                                <section id="ambulancedetail" style="display:none">
                                                                                    <article class="clearfix m-b-10">
                                                                                        <label for="cemail" class="control-label col-md-4 col-sm-4">Name :</label>
                                                                                        <div class="col-md-8 col-sm-8">
                                                                                            <input class="form-control" name="ambulance_name" id="ambulance_name" type="text" value="<?php if (isset($hospitalData[0]->ambulance_name)) {
    echo $hospitalData[0]->ambulance_name;
                                                                                            ...
                                                                                            <div>
                                                                                                ...
                                                                                                <article class="clearfix m-b-10 ">
                                                                                                    ...
                                                                                                    <div class="col-md-8 col-sm-8">
                                                                                                        <aside class="row">
                                                                                                            ...
                                                                                                            <div class="col-xs-10 m-t-xs-10">
                                                                                                                <input type="text" class="form-control" name="ambulance_phn" id="ambulance_phn" value ="<?php if (isset($hospitalData[0]->ambulance_phn) && $hospitalData[0]->ambulance_phn != '') {
                                                                                                ...
                                                                                                <article class="clearfix">
                                                                                                    ...
                                                                                                    <div class="col-md-8 col-xs-3">
                                                                                                        <aside class="checkbox checkbox-success m-t-5">
                                                                                                            <input type="checkbox" id="docOnBoard" name="docOnBoard" value="1" <?php if ($hospitalData[0]->docOnBoard == 1) {
                                                                                                                        echo "checked";
                                                                                                                    } ?> >
                                                                                                            <label>
                                                                                                            </label>
                                                                                                ...
                                                                                                <article class="clearfix">
                                                                                                    ...
                                                                                                    <div class="col-md-8 col-xs-3">
                                                                                                        <aside class="checkbox checkbox-success m-t-5">
                                                                                                            <input type="checkbox" id="isEmergency" name="isEmergency" value="1" <?php if ($hospitalData[0]->isEmergency == 1) {
                                                                                                                        echo "checked";
                                                                                                                    } ?> />
                                                                                                            <label>
                                                                                                            </label>
                                                                                                ...
                                                                                                <article class="clearfix">
                                                                                                    ...
                                                                                                    <div class="col-md-8 col-xs-3">
                                                                                                        <aside class="checkbox checkbox-success m-t-5">
                                                                                                            <input type="checkbox" id="availibility_24_7" name="availibility_24_7" value="1" <?php if ($hospitalData[0]->availibility_24_7 == 1) {
                                                                                                                        echo "checked";
                                                                                                                    } ?> />
                                                                                                            <label>
                                                                                                            </label>
                                                                                                ...
                                                                                                <article class="clearfix m-b-10">
                                                                                                    <label for="cemail" class="control-label col-md-4 col-sm-4">Contact Person:</label>
                                                                                                    <div class="col-md-8 col-sm-8">
                                                                                                        <input class="form-control" id="hospital_cntPrsn" name="hospital_cntPrsn" type="text" value="<?php if (isset($hospitalData[0]->hospital_cntPrsn)) {
                                                                                                                                        echo $hospitalData[0]->hospital_cntPrsn;
                                                                                                                                    } ?>">
                                                                                                ...
                                                                                                <article class="clearfix m-b-10">
                                                                                                    <label for="cemail" class="control-label col-md-4 col-sm-4">Designation :</label>
                                                                                                    <div class="col-md-8 col-sm-8">
                                                                                                        <input class="form-control" id="hospital_dsgn" name="hospital_dsgn" type="text" value="<?php if (isset($hospitalData[0]->hospital_dsgn)) {
                                                                                                                                        echo $hospitalData[0]->hospital_dsgn;
                                                                                                                                    } ?>">
                                                                                                        ...
                                                                                                        <div>
                                                                                                            ...
                                                                                                            <article class="form-group m-lr-0 ">
                                                                                                                <label for="cemail" class="control-label col-md-4 col-sm-4">Docat Id :</label>
                                                                                                                <div class="col-md-8 col-sm-8">
                                                                                                                    <input class="form-control" id="docatId" name="docatId" type="text" value="<?php if (isset($hospitalData[0]->docatId)) {
                                                                                                                                        echo $hospitalData[0]->docatId;
                                                                                                                                    } ?>">
                                                                                                                        ...
                                                                                                                        <div class="col-md-9 col-sm-8">
                                                                                                                            <aside class="row">
                                                                                                                                <div class="col-md-10 col-sm-10 col-xs-10">
                                                                                                                                    ...
                                                                                                                                    <input type="text" class="form-control m-t-10" name="hospitalAwards_agencyName" id="hospitalAwards_agencyName" placeholder="Award Agency" />
                                                                                                                                    <label style="display: none;"class="error" id="error-hospitalAwards_agencyName"> Please enter agency name </label>
                                                                                                                                    <input type="text" class="form-control m-t-10" placeholder="Year" id="hospital_awardsyear" name="hospital_awardsyear" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength="4" />
...
<?php echo $this->load->view('doctorScript.php'); ?>
                                                                                                    ...
                                                                                                    <aside class="col-md-9 setting">
                                                                                                        ...
                                                                                                        <div class="clearfix m-t-20 p-b-20 doctor-description" id="detailac">
                                                                                                            ...
                                                                                                            <article class="clearfix m-b-10">
                                                                                                                ...
                                                                                                                <p class="col-md-8 col-sm-7">+91 <?php if (isset($hospitalData[0]->users_mobile)) {
    echo $hospitalData[0]->users_mobile;
                                                                                                        ...
                                                                                                        <?php if ($hospitalData[0]->hospital_mmbrTyp == 1) {
                                                                                                            echo 'Life Time';
                                                                                                                    ...
                                                                                                                    <div class="col-md-8 col-sm-8">
                                                                                                                        <aside class="row">
                                                                                                                            ...
                                                                                                                            <div class="col-md-9 col-sm-9 col-xs-12 m-t-xs-10">
                                                                                                                                <input type="text" class="form-control" name="users_mobile" id="users_mobile" placeholder="" onkeypress="return isNumberKey(event)" value="<?php if (isset($hospitalData[0]->users_mobile)) {
                                                                                                            echo $hospitalData[0]->users_mobile;
                                                                                                        } ?>" maxlength="10" />
                                                                                                                ...
                                                                                                                <article class="clearfix m-b-10">
                                                                                                                    ...
                                                                                                                    <div class="col-md-8 col-sm-8">
                                                                                                                        <select class="selectpicker" data-width="100%" name="hospital_mmbrTyp" id="hospital_mmbrTyp">
                                                                                                                            <option value="1" <?php if ($hospitalData[0]->hospital_mmbrTyp == 1) {
                                                                                                            echo "selected";
                                                                                                        } ?>>Life Time</option>
                                                                                                                            <option value="2" <?php if ($hospitalData[0]->hospital_mmbrTyp == 2) {
                                                                                                            echo "selected";
                                                                                                        } ?>>Health Club</option>
                                                                                                                        </select>
                                                                                                                    </div>
                                                                                                                ...
                                                                                                                <!-- <input type="text" name="myPassword" id="myPassword" value="<?php if (isset($bloodBankData[0]->users_password)) {
