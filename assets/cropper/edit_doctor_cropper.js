(function (factory) {
  ...
  'use strict';
  var useBlobse = false && window.URL; // `true` to use Blob instead of Data-URL
  var console = window.console || { log: function () {} };

  function CropAvatar($element) {
    this.$container = $element;

    this.$avatarView = this.$container.find('.avatar-view-doctor-edit');
    this.$avatar = this.$avatarView.find('img');
    this.$avatarModal = this.$container.find('#avatar-modal-doctor-edit');
    this.$pre = this.$container.find('.pre-doctor-edit');
    
    this.$loading = this.$container.find('.loading');

    this.$uploadForm = this.$container.find('#submitFormDoctorEdit');


    this.$avatarForm = this.$container.find('.avatar-form-doctor-edit');
  ...
  CropAvatar.prototype = {
    ...
    initPreview: function () {
      this.url = $('#preImgLogoDoctorEdit img').attr('src');
...
//      });
    ...
    readImagesEdit:function (file,currentObj) {
            // 2.1
            ...
            reader.addEventListener("load", function () {
                ...
                image.src = useBlobse ? window.URL.createObjectURL(file) : reader.result;
                // If we set the variable `useBlobse` to true:
