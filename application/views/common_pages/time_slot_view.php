...
<!--                                        <div class="col-md-1">
                            <a href="javascript:void(0)" class="add btn btn-success btn-xs" id="cloneButtonDays_<?php //echo $i; ?>" onclick="addNewSlot('<?php //echo $i; ?>','<?php //echo $dayVal; ?>');"><i class="fa fa-plus"></i></a>
                        </div>-->
                        ...
                        <div class="col-md-3">
                            <input type="text" name="hour_label_<?php echo $i; ?>_1" id="hour_label_<?php echo $i; ?>_1" value='<?php echo $dayVal; ?>' class="form-control" readonly /> 
                        </div>
