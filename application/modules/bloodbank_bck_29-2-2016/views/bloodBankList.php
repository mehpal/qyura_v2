...
<div class="hidden-xs hidden-sm"><a class="logo" href="#"><img src="<?php echo base_url();?>assets/images/qyura-f-l.png"></a>
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li class="active"><a href="<?php echo base_url();?>index.php/bloodbank">All Blood Banks</a></li>
