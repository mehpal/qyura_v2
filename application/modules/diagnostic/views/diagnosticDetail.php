                        ...
                        <div class="bg-white">
                            ...
                            <section class="col-md-12">
                                <aside class="clearfix m-bg-pic">
                                    <div class="bg-picture text-center" style="background-image:url('<?php if(isset($diagnosticData) && !empty($diagnosticData[0]->diagnostic_background_img)): echo base_url().'assets/diagnosticsImage/'.$diagnosticData[0]->diagnostic_background_img; else : echo base_url().'assets/default-images/Diagnostic_Centre.png'; endif;?>')">                                      
...
<!--                                                        <input id="uploadBtn" type="file" class="upload" />-->
                                            ...
                                            <h3 class="text-white"><?php if(isset($diagnosticData)){ if(!empty($diagnosticData)): echo $diagnosticData[0]->diagnostic_name; endif;}?></h3>
                                            <h4><?php if(isset($diagnosticData)){ if(!empty($diagnosticData)): echo $diagnosticData[0]->diagnostic_address; endif;}?></h4>
                                        </div>
                                    </div>
                                    <!--/ meta -->
                                </aside>
...
<!--                                        <li class="<?php if(isset($active) && $active == 'gallery'){echo "active";}?>">
                                        ...
                                        <li class="<?php if(isset($active) && ( $active == 'timeslot'  OR $active ==  'timeSlot' ) ){echo "active";}?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <section id="detail">
                                                            <article class="clearfix m-b-10">
                                                                ...
                                                                <p class="col-md-8 col-sm-8 t-xs-left"><?php if(isset($diagnosticData) && !empty($diagnosticData)): echo ucwords($diagnosticData[0]->diagnostic_name); endif;?></p>
                                                            </article>
                                                            <article class="clearfix m-b-10">
                                                                <label for="cemail" class="control-label col-md-4 col-sm-4">Address :</label>
                  <p class="col-md-8 col-sm-8 t-xs-left"><?php if(!empty($diagnosticData) && isset($diagnosticData)): echo ucwords(strtolower($diagnosticData[0]->diagnostic_address." ".$diagnosticData[0]->diagnostic_zip." ".$diagnosticData[0]->city_name."</br>".$diagnosticData[0]->state_statename.", ".$diagnosticData[0]->country)); endif;?></p>
                                                            </article>
                                                            <article class="clearfix m-b-10">
                                                            ...
                                                            <article class="clearfix m-b-10">
                                                                ...
                                                                <p class="col-md-8 col-sm-8 t-xs-left"><?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->mobile; endif;?></p>
                                                            </article>
                                                            <article class="clearfix m-b-10">
                                                                <label for="cemail" class="control-label col-md-4 col-sm-4">Contact Person:</label>
                                                                <p class="col-md-8 col-sm-8 t-xs-left"><?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->diagnostic_cntPrsn; endif;?></p>
                                                            </article>
                                                            <article class="clearfix m-b-10">
                                                                <label for="cemail" class="control-label col-md-4 col-sm-4">Designation:</label>
                                                                <p class="col-md-8 col-sm-8 t-xs-left"><?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->diagnostic_dsgn; endif;?></p>
                                                            </article>

        <article class="clearfix m-b-10">
                                                                <label for="cemail" class="control-label col-md-4 col-sm-4">About Us:</label>
                                                                <p class="col-md-8 col-sm-8 t-xs-left"><?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->diagnostic_aboutUs; endif;?></p>
                                                            </article>

<div class="map_canvas"></div>
                                                        </section>
                                                        
    <?php $formId =0; if(isset($diagnosticData) && !empty($diagnosticData)){$formId= $diagnosticData[0]->diagnostic_id;}?>                                                    <section id="newDetail" style="display:none;">     
                                                     ...
                                                     <input type="hidden" id="diagnostic_id" name="diagnostic_id" value="<?php echo $diagnosticData[0]->diagnostic_id;?>" />
                                                            ...
                                                            <article class="clearfix m-t-10">
                                                                ...
                                                                <div class="col-md-8 col-sm-8">
                                                                    <input class="form-control" id="diagnosticCenter" name="diagnostic_name" type="text" required="" value="<?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->diagnostic_name; endif;?>" />
								...
								<article class="clearfix">
                                                     ...
                                                     <label class="error" > <?php echo form_error("diagnostic_cityId"); ?></label>
                                                           ...
                                                           <article class="clearfix">
                                                                  <div class="col-sm-8 col-sm-offset-4">
                                                                            <input type="text" class="form-control" id="diagnostic_zip" name="diagnostic_zip" placeholder="" value="<?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->diagnostic_zip; endif;?>" onkeypress="return isNumberKey(event)"/>
                                                    ...
                                                    <label class="error" > <?php echo form_error("diagnostic_zip"); ?></label>
                                                                     ...
                                                                     <article class="clearfix m-t-10">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <aside class="radio radio-info radio-inline">
                                                                                    <input type="radio" <?php if(!empty($diagnosticData) && isset($diagnosticData) &&  $diagnosticData[0]->isManual == 1 ){ echo 'checked="checked" '; }?>  name="isManual" value="1" id="isManual" onclick="IsAdrManual(this.value)">
                                                                                    <label for="inlineRadio1"> Yes</label>
                                                                                </aside>
                                                                                <aside class="radio radio-info radio-inline">
                                                                                    <input type="radio" <?php if(!empty($diagnosticData) &&  isset($diagnosticData) && $diagnosticData[0]->isManual == 0 ){ echo 'checked="checked" '; }?> name="isManual" value="0" id="isManual" onclick="IsAdrManual(this.value)">
                                                                  ...
                                                                  <div class="col-sm-8 col-sm-offset-4">
                                                                    <aside class="clearfix">
                                                                        <input type="text" class="form-control" id="geocompleteId" name="diagnostic_address" placeholder="" value="<?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->diagnostic_address; endif;?>"/>
                                                        ...
                                                        <article class="clearfix">
                                                            ...
                                                            <aside class="row">
                                                        <div class="col-sm-6">
                                                        <input name="lat" class="form-control" required="" type="text"   id="lat" <?php if(!empty($diagnosticData) && isset($diagnosticData) &&  $diagnosticData[0]->isManual == 0 ){ echo ''; }?> value="<?php echo $diagnosticData[0]->diagnostic_lat;?>" onchange="latChack(this.value)" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                                        ...
                                                        <label class="error" > <?php echo form_error("lat"); ?></label>
                                                         ...
                                                         <input name="lng" class="form-control" required="" type="text"  id="lng" <?php if(!empty($diagnosticData) && $diagnosticData[0]->isManual == 0 ){ echo ''; }?> value="<?php echo $diagnosticData[0]->diagnostic_long;?>" onchange="lngChack(this.value)" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                                    ...
                                                    <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength="5" value="<?php if(isset($moreExpolde[1])){ echo $moreExpolde[1];}?>"  id="midNumber" name="midNumber[]" class="form-control" requird>
                                                     <label class="error" style="display:none;" id="error-midNumber"> please enter a valid phone Std Code</label>
                                                    <label class="error" > <?php echo form_error("midNumber"); ?></label>
                                                </div>
                                                                        <div class="col-md-5 col-sm-5 col-xs-12 m-t-xs-10">
                                                                            <input type="text" class="form-control" name="diagnostic_phn[]" id="diagnostic_phn<?php echo ($i+1);?>" placeholder="" value="<?php if(isset($moreExpolde[2])){ echo $moreExpolde[2];}?>" maxlength="10" onkeypress="return isNumberKey(event)"/>
                                                                        </div>
                                                                    </aside>
                                                                   <!-- </br> -->
                                                                       <?php $moreExpolde ='';}}?>
 ...
 <input type="text" class="form-control" id="diagnostic_mobileNo" name="diagnostic_mobileNo" placeholder="" value="<?php echo $diagnosticData[0]->mobile; ?>" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                                            ...
                                                            <article class="clearfix m-t-10">
                                                                <label for="cemail" class="control-label col-md-4 col-sm-4">Contact Person:</label>
                                                                <div class="col-md-8 col-sm-8">
                                                                    <input class="form-control" id="diagnostic_cntPrsn" name="diagnostic_cntPrsn" type="text" required="" value="<?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->diagnostic_cntPrsn; endif;?>" />
                                            ...
                                            <label class="error" > <?php echo form_error("diagnostic_cntPrsn"); ?></label>
                                                            ...
                                                            <article class="clearfix m-t-10">
                                                                <label for="cemail" class="control-label col-md-4 col-sm-4">Designation :</label>
                                                                <div class="col-md-8 col-sm-8">
                                                                    <input class="form-control" id="diagnostic_dsgn" name="diagnostic_dsgn" type="text" required="" value="<?php if(!empty($diagnosticData) && isset($diagnosticData)): echo $diagnosticData[0]->diagnostic_dsgn; endif;?>" />
...
<!--                                                                    <input class="form-control" id="diagnostic_aboutUs" name="diagnostic_aboutUs" type="text" required="" value="" />-->
                                                                <textarea value="" id="diagnostic_aboutUs" name="diagnostic_aboutUs" class="form-control" maxlength="255"><?php if (isset($diagnosticData) && !empty($diagnosticData)): echo $diagnosticData[0]->diagnostic_aboutUs;
endif; ?></textarea>
                        ...
                        <div class="col-lg-9 col-sm-8">
                            <aside class="row">
                                <div class="col-md-12 ">
                                    ...
                                    <input type="text" class="form-control m-t-20" placeholder="2016" id="diagnostic_awardsyear" name="diagnostic_awardsyear" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  />
...
<!--Specialities Starts -->
<section class="tab-pane fade in" id="specialities" <?php if(isset($active) && $active == 'specialities'){echo "active";}?>">
    
      <article class="clearfix">
                                <label class="control-label col-md-4" for="cname">Speciality Name display format:</label>
                                <div class="col-md-8">
                                    <aside class="radio radio-info radio-inline">
                                        <input <?php  echo set_radio('specialityNameFormate', '1', TRUE); ?> type="radio"  name="specialityNameFormate" value="1" id="specialityNameFormate" onclick="setSpecialityNameFormate(this.value)" <?php if($diagnosticData[0]->diagnostic_specialityNameFormate == 1){ echo "checked";}?> >
                                        <label for="inlineRadio1"> General Name</label>
                                    </aside>
                                    <aside class="radio radio-info radio-inline">
                                        <input <?php  echo set_radio('specialityNameFormate', '0'); ?> type="radio" name="specialityNameFormate" value="0" id="specialityNameFormate" onclick="setSpecialityNameFormate(this.value)" <?php if($diagnosticData[0]->diagnostic_specialityNameFormate == 0){ echo "checked";}?>>
...
if(!empty($diagnosticData) && isset($diagnosticData)){
    $diaId = $diagnosticData[0]->diagnostic_id;
                              ...
                              <!--Timeslot Starts -->
  <section class="tab-pane fade in <?php if(isset($active) && ($active == 'timeslot'  OR $active ==  'timeSlot')){echo "active";}?>" id="timeslot">
                    ...
                    <form method="post" name="timeSlotForm" id="timeSlotForm" action="<?php echo site_url('diagnostic/updateTimeSlot');?>">
                        ...
                        <input type="hidden" name="mi_user_id" value="<?php if(isset($diagnosticData[0]->diagnostic_usersId)){ echo $diagnosticData[0]->diagnostic_usersId; }?>" id="mi_user_id" />
                        
                         <input type="hidden" name="mi_id" value="<?php if(isset($diagnosticData[0]->diagnostic_id)){ echo $diagnosticData[0]->diagnostic_id; }?>" />
                    ...
                    <?php else: ?>
                       ...
                       <form method="post" name="timeSlotForm" id="timeSlotForm" action="<?php echo site_url('diagnostic/setTimeSlotMi');?>">
                         <input type="hidden" name="mi_user_id" value="<?php if(isset($diagnosticData[0]->diagnostic_usersId)){ echo $diagnosticData[0]->diagnostic_usersId; }?>" />
                         <input type="hidden" name="mi_id" value="<?php if(isset($diagnosticData[0]->diagnostic_id)){ echo $diagnosticData[0]->diagnostic_id; }?>" />
                    ...
                    <?php endif;?>
                            ...
                            <section class="tab-pane fade in <?php if (isset($active) && $active == 'doctor') {
    echo "active";
} ?>" id="doctor">
                                <!-- Form Section Start -->
...
<!--                                    <form name="addDigoDocForm" action="#" id="addDigoDocForm" method="post">    
                                        <aside class="col-md-4 col-sm-4 m-tb-xs-3">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" id="digoId" name="digoId" value="<?php if (isset($diagnosticData[0]->diagnostic_usersId) && $diagnosticData[0]->diagnostic_usersId != NULL) {
    echo $diagnosticData[0]->diagnostic_usersId;
} else {
    echo "";
} ?>" >
                                                <input type="hidden" id="ajaxDigoId" name="ajaxDigoId" value="<?php if (isset($diagnosticData[0]->diagnostic_id) && $diagnosticData[0]->diagnostic_id != NULL) {
...
<!--                                                 </article> -->
                                            ...
                                            <aside id="newac" style="display:none">
                                                <article class="clearfix m-b-10">
                                                    ...
                                                    <div class="col-md-8 col-sm-8">
                                                        <input class="form-control" id="users_email" name="users_email" type="text" value="<?php if(!empty($diagnosticData)): echo $diagnosticData[0]->users_email; endif;?>" onblur="checkEmailFormat()" required="" readonly="">
                                                        <label class="error" style="display:none;" id="error-users_email"> please enter Email id Properly</label>
