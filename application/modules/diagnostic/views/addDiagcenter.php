                            ...
                            <div class="bg-white mi-form-section">
                                ...
                                <article class="clearfix m-t-10">
                                            ...
                                            <div class="col-md-8 col-sm-8">
                                                <?php $publishDiagno[] = (object) array('diagnostic_id' => 0, 'diagnostic_name' => 'Other') ?>
                                                <select class="form-control selectpicker" data-width="100%" name="diagno_id" id="diagno_id" onchange="getDiagnodetail(this.value)" >
                                                    ...
                                                    <?php if (!empty($publishDiagno)) {

                                                        foreach ($publishDiagno as $key => $val) {
                                                            ?>
                                                            <option <?php echo set_select('diagno_id', $val->diagno_id); ?> value="<?php echo $val->diagnostic_id; ?>"> <?php echo $val->diagnostic_name; ?></option>
                                                        <?php }
                                                    }
                                                    ?>
                                    ...
                                    <article class="clearfix m-t-10" style="<?php if(isset($diagno_id) && $diagno_id == 0){ echo 'display:block'; }else{ echo 'display:none'; } ?>" id="diagnoName">
 ...
 <input type="text" class="form-control" id="diagnostic_zip" name="diagnostic_zip" placeholder="Zip code" value="<?php echo set_value('diagnostic_zip'); ?>" maxlength="6" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            ...
                                            <aside class="row" id="phone_list">
                                                ...
                                                <div class="col-xs-10 m-t-xs-10" id="multiPhoneNumber">
                                                    <input type="text" class="form-control" name="diagnostic_phn[]" id="diagnostic_phn1" placeholder="" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php set_value('diagnostic_phn[0]'); ?>" minlength="10" pattern=".{10,10}"/>
                            ...
                            <article class="clearfix m-t-10">
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <section class="clearfix m-t-10" id="bloodbankOption" style="<?php if(isset($bloodBankstatus) && $bloodBankstatus == 1){ echo 'display:block'; }else{ echo 'display:none'; } ?>">
                                        <article class="clearfix m-t-10 ">
                                    ...
                                    <section class="clearfix m-t-10" id="ambulanceOption" style="<?php if(isset($amobulancestatus) && $amobulancestatus == 1){ echo 'display:block'; }else{ echo 'display:none'; } ?>">
                                        <article class="form-group m-lr-0 ">
                                            <label for="cemail" class="control-label col-md-4 col-sm-4">Name : </label>
                                            <div class="col-md-8 col-sm-8">
