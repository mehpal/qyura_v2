...
AND `healthPkgBooking_deleted` = 0 UNION SELECT doctorAppointment_id as id, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 1 ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 2 ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS title,`qyura_doctorAppointment`.`doctorAppointment_unqId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%d %b, %Y') as date,DATE_FORMAT(`docTimeDay_open`,'%h:%i%p') as startTime,DATE_FORMAT(`docTimeDay_close`,'%h:%i%p') as endTime, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 3 ) THEN (CASE WHEN (docTimeTable_stayAt = 0) THEN psChamber_name ELSE  CASE WHEN (docTimeTable_MItype = 1) THEN hospital_name WHEN (docTimeTable_MItype = 2) THEN diagnostic_name ELSE '' END END ) ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS address, CASE WHEN (concat(DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%Y-%m-%d'),' ',DATE_FORMAT(docTimeDay_open, '%h:%i %p')) > DATE_FORMAT(CURRENT_TIMESTAMP, '%Y-%m-%d %h:%i %p') AND (qyura_doctorAppointment.doctorAppointment_status = 11 || qyura_doctorAppointment.doctorAppointment_status = 14  )) THEN 'Upcoming' ELSE 'Completed' END as `upcomingStatus`, CASE qyura_doctorAppointment.doctorAppointment_status WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END  AS `bookingStatus`,'Consultation' as `type`, '3' as typeId FROM `qyura_doctorAppointment`
                    ...
                    AND `qyura_doctorAppointment`.`doctorAppointment_deleted` = 0
                    AND `qyura_doctorAppointment`.`doctorAppointment_date` <> 0
ERROR - 2016-05-14 17:45:11 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '`.`hospital_name` WHEN (diagnostic_name IS NOT NULL ) THEN `qyura_diagnostic`.`d' at line 1 - Invalid query: SELECT quotation_id as id, `qyura_quotationBooking`.`CASE WHEN (hospital_name IS NOT NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name IS NOT NULL ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE  '' END AS title,`qyura_quotationBooking`.`quotationBooking_orderId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_quotations`.`quotation_dateTime`),'%d %b, %Y') as date,0 AS `startTime`,0 AS `endTime`,CASE WHEN (`qyura_hospital`.`hospital_usersId` <> 0 ) THEN qyura_hospital.hospital_address ELSE qyura_diagnostic.diagnostic_address END AS `address`,(CASE WHEN(quotation_dateTime > CURRENT_TIMESTAMP AND (quotationBooking_bookStatus = 11 || quotationBooking_bookStatus = 14  ))  THEN 'Upcoming' ELSE 'Completed' END  ) as `upcomingStatus`,CASE qyura_quotationBooking.quotationBooking_bookStatus WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END AS `bookingStatus`,'Diagnostic' as `type`, '2' as `typeId`FROM `qyura_quotationBooking` LEFT JOIN `transactionInfo` ON `transactionInfo`.`order_no` = `qyura_quotationBooking`.`quotationBooking_orderId`
...
AND `healthPkgBooking_deleted` = 0 UNION SELECT doctorAppointment_id as id, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 1 ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 2 ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS title,`qyura_doctorAppointment`.`doctorAppointment_unqId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%d %b, %Y') as date,DATE_FORMAT(`docTimeDay_open`,'%h:%i%p') as startTime,DATE_FORMAT(`docTimeDay_close`,'%h:%i%p') as endTime, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 3 ) THEN (CASE WHEN (docTimeTable_stayAt = 0) THEN psChamber_name ELSE  CASE WHEN (docTimeTable_MItype = 1) THEN hospital_name WHEN (docTimeTable_MItype = 2) THEN diagnostic_name ELSE '' END END ) ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS address, CASE WHEN (concat(DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%Y-%m-%d'),' ',DATE_FORMAT(docTimeDay_open, '%h:%i %p')) > DATE_FORMAT(CURRENT_TIMESTAMP, '%Y-%m-%d %h:%i %p') AND (qyura_doctorAppointment.doctorAppointment_status = 11 || qyura_doctorAppointment.doctorAppointment_status = 14  )) THEN 'Upcoming' ELSE 'Completed' END as `upcomingStatus`, CASE qyura_doctorAppointment.doctorAppointment_status WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END  AS `bookingStatus`,'Consultation' as `type`, '3' as typeId FROM `qyura_doctorAppointment`
                    ...
                    AND `qyura_doctorAppointment`.`doctorAppointment_deleted` = 0
                    AND `qyura_doctorAppointment`.`doctorAppointment_date` <> 0
ERROR - 2016-05-14 17:46:35 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '` IS NOT NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name IS N' at line 1 - Invalid query: SELECT quotation_id as id, `qyura_quotationBooking`.`CASE WHEN (`hospital_name` IS NOT NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name IS NOT NULL ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE  '' END AS title,`qyura_quotationBooking`.`quotationBooking_orderId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_quotations`.`quotation_dateTime`),'%d %b, %Y') as date,0 AS `startTime`,0 AS `endTime`,CASE WHEN (`qyura_hospital`.`hospital_usersId` <> 0 ) THEN qyura_hospital.hospital_address ELSE qyura_diagnostic.diagnostic_address END AS `address`,(CASE WHEN(quotation_dateTime > CURRENT_TIMESTAMP AND (quotationBooking_bookStatus = 11 || quotationBooking_bookStatus = 14  ))  THEN 'Upcoming' ELSE 'Completed' END  ) as `upcomingStatus`,CASE qyura_quotationBooking.quotationBooking_bookStatus WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END AS `bookingStatus`,'Diagnostic' as `type`, '2' as `typeId`FROM `qyura_quotationBooking` LEFT JOIN `transactionInfo` ON `transactionInfo`.`order_no` = `qyura_quotationBooking`.`quotationBooking_orderId`
...
AND `healthPkgBooking_deleted` = 0 UNION SELECT doctorAppointment_id as id, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 1 ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 2 ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS title,`qyura_doctorAppointment`.`doctorAppointment_unqId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%d %b, %Y') as date,DATE_FORMAT(`docTimeDay_open`,'%h:%i%p') as startTime,DATE_FORMAT(`docTimeDay_close`,'%h:%i%p') as endTime, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 3 ) THEN (CASE WHEN (docTimeTable_stayAt = 0) THEN psChamber_name ELSE  CASE WHEN (docTimeTable_MItype = 1) THEN hospital_name WHEN (docTimeTable_MItype = 2) THEN diagnostic_name ELSE '' END END ) ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS address, CASE WHEN (concat(DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%Y-%m-%d'),' ',DATE_FORMAT(docTimeDay_open, '%h:%i %p')) > DATE_FORMAT(CURRENT_TIMESTAMP, '%Y-%m-%d %h:%i %p') AND (qyura_doctorAppointment.doctorAppointment_status = 11 || qyura_doctorAppointment.doctorAppointment_status = 14  )) THEN 'Upcoming' ELSE 'Completed' END as `upcomingStatus`, CASE qyura_doctorAppointment.doctorAppointment_status WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END  AS `bookingStatus`,'Consultation' as `type`, '3' as typeId FROM `qyura_doctorAppointment`
                    ...
                    AND `qyura_doctorAppointment`.`doctorAppointment_deleted` = 0
                    AND `qyura_doctorAppointment`.`doctorAppointment_date` <> 0
ERROR - 2016-05-14 17:46:42 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '` IS NOT NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name IS N' at line 1 - Invalid query: SELECT quotation_id as id, `qyura_quotationBooking`.`CASE WHEN (`hospital_name` IS NOT NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name IS NOT NULL ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE  '' END AS title,`qyura_quotationBooking`.`quotationBooking_orderId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_quotations`.`quotation_dateTime`),'%d %b, %Y') as date,0 AS `startTime`,0 AS `endTime`,CASE WHEN (`qyura_hospital`.`hospital_usersId` <> 0 ) THEN qyura_hospital.hospital_address ELSE qyura_diagnostic.diagnostic_address END AS `address`,(CASE WHEN(quotation_dateTime > CURRENT_TIMESTAMP AND (quotationBooking_bookStatus = 11 || quotationBooking_bookStatus = 14  ))  THEN 'Upcoming' ELSE 'Completed' END  ) as `upcomingStatus`,CASE qyura_quotationBooking.quotationBooking_bookStatus WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END AS `bookingStatus`,'Diagnostic' as `type`, '2' as `typeId`FROM `qyura_quotationBooking` LEFT JOIN `transactionInfo` ON `transactionInfo`.`order_no` = `qyura_quotationBooking`.`quotationBooking_orderId`
...
AND `healthPkgBooking_deleted` = 0 UNION SELECT doctorAppointment_id as id, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 1 ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 2 ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS title,`qyura_doctorAppointment`.`doctorAppointment_unqId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%d %b, %Y') as date,DATE_FORMAT(`docTimeDay_open`,'%h:%i%p') as startTime,DATE_FORMAT(`docTimeDay_close`,'%h:%i%p') as endTime, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 3 ) THEN (CASE WHEN (docTimeTable_stayAt = 0) THEN psChamber_name ELSE  CASE WHEN (docTimeTable_MItype = 1) THEN hospital_name WHEN (docTimeTable_MItype = 2) THEN diagnostic_name ELSE '' END END ) ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS address, CASE WHEN (concat(DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%Y-%m-%d'),' ',DATE_FORMAT(docTimeDay_open, '%h:%i %p')) > DATE_FORMAT(CURRENT_TIMESTAMP, '%Y-%m-%d %h:%i %p') AND (qyura_doctorAppointment.doctorAppointment_status = 11 || qyura_doctorAppointment.doctorAppointment_status = 14  )) THEN 'Upcoming' ELSE 'Completed' END as `upcomingStatus`, CASE qyura_doctorAppointment.doctorAppointment_status WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END  AS `bookingStatus`,'Consultation' as `type`, '3' as typeId FROM `qyura_doctorAppointment`
                    ...
                    AND `qyura_doctorAppointment`.`doctorAppointment_deleted` = 0
                    AND `qyura_doctorAppointment`.`doctorAppointment_date` <> 0
ERROR - 2016-05-14 17:46:46 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '` IS NOT NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name IS N' at line 1 - Invalid query: SELECT quotation_id as id, `qyura_quotationBooking`.`CASE WHEN (`hospital_name` IS NOT NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name IS NOT NULL ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE  '' END AS title,`qyura_quotationBooking`.`quotationBooking_orderId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_quotations`.`quotation_dateTime`),'%d %b, %Y') as date,0 AS `startTime`,0 AS `endTime`,CASE WHEN (`qyura_hospital`.`hospital_usersId` <> 0 ) THEN qyura_hospital.hospital_address ELSE qyura_diagnostic.diagnostic_address END AS `address`,(CASE WHEN(quotation_dateTime > CURRENT_TIMESTAMP AND (quotationBooking_bookStatus = 11 || quotationBooking_bookStatus = 14  ))  THEN 'Upcoming' ELSE 'Completed' END  ) as `upcomingStatus`,CASE qyura_quotationBooking.quotationBooking_bookStatus WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END AS `bookingStatus`,'Diagnostic' as `type`, '2' as `typeId`FROM `qyura_quotationBooking` LEFT JOIN `transactionInfo` ON `transactionInfo`.`order_no` = `qyura_quotationBooking`.`quotationBooking_orderId`
...
AND `healthPkgBooking_deleted` = 0 UNION SELECT doctorAppointment_id as id, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 1 ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 2 ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS title,`qyura_doctorAppointment`.`doctorAppointment_unqId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%d %b, %Y') as date,DATE_FORMAT(`docTimeDay_open`,'%h:%i%p') as startTime,DATE_FORMAT(`docTimeDay_close`,'%h:%i%p') as endTime, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 3 ) THEN (CASE WHEN (docTimeTable_stayAt = 0) THEN psChamber_name ELSE  CASE WHEN (docTimeTable_MItype = 1) THEN hospital_name WHEN (docTimeTable_MItype = 2) THEN diagnostic_name ELSE '' END END ) ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS address, CASE WHEN (concat(DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%Y-%m-%d'),' ',DATE_FORMAT(docTimeDay_open, '%h:%i %p')) > DATE_FORMAT(CURRENT_TIMESTAMP, '%Y-%m-%d %h:%i %p') AND (qyura_doctorAppointment.doctorAppointment_status = 11 || qyura_doctorAppointment.doctorAppointment_status = 14  )) THEN 'Upcoming' ELSE 'Completed' END as `upcomingStatus`, CASE qyura_doctorAppointment.doctorAppointment_status WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END  AS `bookingStatus`,'Consultation' as `type`, '3' as typeId FROM `qyura_doctorAppointment`
                    ...
                    AND `qyura_doctorAppointment`.`doctorAppointment_deleted` = 0
                    AND `qyura_doctorAppointment`.`doctorAppointment_date` <> 0
ERROR - 2016-05-14 17:47:27 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '` <> NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name <> NULL ' at line 1 - Invalid query: SELECT quotation_id as id, `qyura_quotationBooking`.`CASE WHEN ( `hospital_name` <> NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (diagnostic_name <> NULL ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE  '' END AS title,`qyura_quotationBooking`.`quotationBooking_orderId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_quotations`.`quotation_dateTime`),'%d %b, %Y') as date,0 AS `startTime`,0 AS `endTime`,CASE WHEN (`qyura_hospital`.`hospital_usersId` <> 0 ) THEN qyura_hospital.hospital_address ELSE qyura_diagnostic.diagnostic_address END AS `address`,(CASE WHEN(quotation_dateTime > CURRENT_TIMESTAMP AND (quotationBooking_bookStatus = 11 || quotationBooking_bookStatus = 14  ))  THEN 'Upcoming' ELSE 'Completed' END  ) as `upcomingStatus`,CASE qyura_quotationBooking.quotationBooking_bookStatus WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END AS `bookingStatus`,'Diagnostic' as `type`, '2' as `typeId`FROM `qyura_quotationBooking` LEFT JOIN `transactionInfo` ON `transactionInfo`.`order_no` = `qyura_quotationBooking`.`quotationBooking_orderId`
...
AND `healthPkgBooking_deleted` = 0 UNION SELECT doctorAppointment_id as id, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 1 ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 2 ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS title,`qyura_doctorAppointment`.`doctorAppointment_unqId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%d %b, %Y') as date,DATE_FORMAT(`docTimeDay_open`,'%h:%i%p') as startTime,DATE_FORMAT(`docTimeDay_close`,'%h:%i%p') as endTime, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 3 ) THEN (CASE WHEN (docTimeTable_stayAt = 0) THEN psChamber_name ELSE  CASE WHEN (docTimeTable_MItype = 1) THEN hospital_name WHEN (docTimeTable_MItype = 2) THEN diagnostic_name ELSE '' END END ) ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS address, CASE WHEN (concat(DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%Y-%m-%d'),' ',DATE_FORMAT(docTimeDay_open, '%h:%i %p')) > DATE_FORMAT(CURRENT_TIMESTAMP, '%Y-%m-%d %h:%i %p') AND (qyura_doctorAppointment.doctorAppointment_status = 11 || qyura_doctorAppointment.doctorAppointment_status = 14  )) THEN 'Upcoming' ELSE 'Completed' END as `upcomingStatus`, CASE qyura_doctorAppointment.doctorAppointment_status WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END  AS `bookingStatus`,'Consultation' as `type`, '3' as typeId FROM `qyura_doctorAppointment`
                    ...
                    AND `qyura_doctorAppointment`.`doctorAppointment_deleted` = 0
                    AND `qyura_doctorAppointment`.`doctorAppointment_date` <> 0
ERROR - 2016-05-14 17:49:04 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '`.`hospital_usersId` <> NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyur' at line 1 - Invalid query: SELECT quotation_id as id, `qyura_quotationBooking`.`CASE WHEN ( `qyura_hospital`.`hospital_usersId` <> NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_diagnostic`.`diagnostic_usersId` <> NULL ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE  '' END AS title,`qyura_quotationBooking`.`quotationBooking_orderId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_quotations`.`quotation_dateTime`),'%d %b, %Y') as date,0 AS `startTime`,0 AS `endTime`,CASE WHEN (`qyura_hospital`.`hospital_usersId` <> 0 ) THEN qyura_hospital.hospital_address ELSE qyura_diagnostic.diagnostic_address END AS `address`,(CASE WHEN(quotation_dateTime > CURRENT_TIMESTAMP AND (quotationBooking_bookStatus = 11 || quotationBooking_bookStatus = 14  ))  THEN 'Upcoming' ELSE 'Completed' END  ) as `upcomingStatus`,CASE qyura_quotationBooking.quotationBooking_bookStatus WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END AS `bookingStatus`,'Diagnostic' as `type`, '2' as `typeId`FROM `qyura_quotationBooking` LEFT JOIN `transactionInfo` ON `transactionInfo`.`order_no` = `qyura_quotationBooking`.`quotationBooking_orderId`
...
AND `healthPkgBooking_deleted` = 0 UNION SELECT doctorAppointment_id as id, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 1 ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 2 ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS title,`qyura_doctorAppointment`.`doctorAppointment_unqId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%d %b, %Y') as date,DATE_FORMAT(`docTimeDay_open`,'%h:%i%p') as startTime,DATE_FORMAT(`docTimeDay_close`,'%h:%i%p') as endTime, CASE WHEN (`qyura_doctorAppointment`.`doctorAppointment_docType` = 3 ) THEN (CASE WHEN (docTimeTable_stayAt = 0) THEN psChamber_name ELSE  CASE WHEN (docTimeTable_MItype = 1) THEN hospital_name WHEN (docTimeTable_MItype = 2) THEN diagnostic_name ELSE '' END END ) ELSE concat(`doctors_fName`,' ',`doctors_lName`) END AS address, CASE WHEN (concat(DATE_FORMAT(FROM_UNIXTIME(`qyura_doctorAppointment`.`doctorAppointment_date`),'%Y-%m-%d'),' ',DATE_FORMAT(docTimeDay_open, '%h:%i %p')) > DATE_FORMAT(CURRENT_TIMESTAMP, '%Y-%m-%d %h:%i %p') AND (qyura_doctorAppointment.doctorAppointment_status = 11 || qyura_doctorAppointment.doctorAppointment_status = 14  )) THEN 'Upcoming' ELSE 'Completed' END as `upcomingStatus`, CASE qyura_doctorAppointment.doctorAppointment_status WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END  AS `bookingStatus`,'Consultation' as `type`, '3' as typeId FROM `qyura_doctorAppointment`
                    ...
                    AND `qyura_doctorAppointment`.`doctorAppointment_deleted` = 0
                    AND `qyura_doctorAppointment`.`doctorAppointment_date` <> 0
ERROR - 2016-05-14 17:49:52 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'WHEN ( `qyura_hospital`.`hospital_usersId` <> NULL ) THEN `qyura_hospital`.`hosp' at line 1 - Invalid query: SELECT quotation_id as id, `qyura_quotationBooking`.CASE WHEN ( `qyura_hospital`.`hospital_usersId` <> NULL ) THEN `qyura_hospital`.`hospital_name` WHEN (`qyura_diagnostic`.`diagnostic_usersId` <> NULL ) THEN `qyura_diagnostic`.`diagnostic_name` ELSE  '' END AS title,`qyura_quotationBooking`.`quotationBooking_orderId` AS `orderId`,DATE_FORMAT(FROM_UNIXTIME(`qyura_quotations`.`quotation_dateTime`),'%d %b, %Y') as date,0 AS `startTime`,0 AS `endTime`,CASE WHEN (`qyura_hospital`.`hospital_usersId` <> 0 ) THEN qyura_hospital.hospital_address ELSE qyura_diagnostic.diagnostic_address END AS `address`,(CASE WHEN(quotation_dateTime > CURRENT_TIMESTAMP AND (quotationBooking_bookStatus = 11 || quotationBooking_bookStatus = 14  ))  THEN 'Upcoming' ELSE 'Completed' END  ) as `upcomingStatus`,CASE qyura_quotationBooking.quotationBooking_bookStatus WHEN '12' THEN 'Confirmed' WHEN '13' THEN 'Cancelled' WHEN '11' THEN 'Pending' WHEN '14' THEN 'Completed' WHEN '19' THEN 'Expired' ELSE '' END AS `bookingStatus`,'Diagnostic' as `type`, '2' as `typeId`FROM `qyura_quotationBooking` LEFT JOIN `transactionInfo` ON `transactionInfo`.`order_no` = `qyura_quotationBooking`.`quotationBooking_orderId`
