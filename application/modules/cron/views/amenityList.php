                                    ...
                                    foreach ($amenity as $am){
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-md-4" id="re">
                                                <a onclick="editAmenity('<?php echo $am->amenityId;?>');" class="btn btn-success btn-xs" href="javascript:;">
                                                    <i class="fa fa-pencil-square "></i> Edit 
                                                </a>  
                                                <a  class="btn default btn-xs btn-warning" href="javascript:;" onclick="amenityImageGallary('<?php echo $am->amenityId;?>');">
