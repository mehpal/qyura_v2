                            ...
                            <div class="bg-white mi-form-section">
                                ...
                                <div class="clearfix m-t-20 p-b-20">
                                    ...
                                    <article class="clearfix m-t-10">
                                        ...
                                        <div class="col-md-8 col-sm-8 text-right" data-target="#modal" data-toggle="modal">
...
<!--                                            <input type="file" style="display:none;" class="no-display" id="file-input" name="bloodBank_photo">-->
                                    ...
                                    <article class="clearfix">
                                        <div class="col-md-8 col-sm-8 col-sm-offset-4">
                                                    <select class="selectpicker" data-width="100%" name="stateId" Id="stateId" data-size="4" onchange ="fetchCity(this.value)">
                                                       ...
                                                       <?php if(isset($allStates) && !empty($allStates)){ foreach($allStates as $key=>$val) {?>
                                    ...
                                    <article class="clearfix">
                                        <div class="col-sm-8 col-sm-offset-4">
                                                    <select class="selectpicker" data-width="100%" name="cityId" id="cityId" data-size="4">
                                                       ...
                                                       <?php if(isset($allCities) && !empty($allCities)){ foreach($allCities as $key=>$val) {?>
                                    ...
                                    <article class="clearfix m-t-10">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <aside class="row clone">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-12 m-t-xs-10">
                                                    <input type="text" class="form-control" name="midNumber[]" id="midNumber1" maxlength="5" onkeypress="return isNumberKey(event)" <?php set_value('midNumber[0]') ?> />
                                                ...
                                                <div class="col-md-5 col-sm-5 col-xs-10 m-t-xs-10 " id="multiPhoneNumber">
                                                    <input type="text" class="form-control" name="bloodBank_phn[]" id="bloodBank_phn1" maxlength="8" onkeypress="return isNumberKey(event)" <?php set_value('bloodBank_phn[0]') ?> />
                                                    <label class="error" style="display:none;" id="error-bloodBank_phn"> please enter a valid phone number</label>
                                                    <label class="error" > <?php echo form_error("bloodBank_phn[0]"); ?></label>
                                                </div>
                                            </aside>
                                     ...
                                     <article class="clearfix m-t-10">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input type="text" value="" onkeypress="return isNumberKey(event)" maxlength="10" placeholder="" name="bloodBank_mbl" id="bloodBank_mbl" class="form-control" <?php set_value('bloodBank_mbl'); ?>>
                                           
                                           <label id="error-bloodBank_mbl" style="display:none;" class="error">please enter digits only!</label>
                                           <label class="error" > <?php echo form_error("bloodBank_mbl"); ?></label>
