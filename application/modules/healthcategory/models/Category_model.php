...
class Category_model extends CI_Model {
    ...
    function fetchCategory ($categoryId=NULL){
    ...
    //Prachi
    function fetchCategoryData($conditionId = NULL){
       $this->db->select('cat.category_id,cat.category_name');
       $this->db->from('qyura_healthCategory cat');
       if($conditionId)
            $this->db->where(array('cat.category_id'=> $conditionId));
    ...
    $this->db->select('*');
    $this->db->from('qyura_healthCategory AS cat');
