(function (factory) {
    ...
    var CropAvatar = function ($element, $modalId) {
        ...
        this.$avatarCropBtns = this.$avatarForm.find('.avatar-crop-btns');
    ...
    CropAvatar.prototype = {
        ...
        addListener: function () {
            ...
            this.$avatarCropBtns.on('click', $.proxy(this.clickCamCropper, this));
...
//      });
        ...
        clickCamCropper: function () {
            var _this = this;
            var json = this.$img.cropper('getData');
            _this.$avatarData.val(JSON.stringify(json));
            ...
            reader.addEventListener("load", function () {
                ...
                image.addEventListener("load", function () {
                    ...
                    if (image.width < 160 || image.height < 160) {
                        ...
                        bootbox.alert("Image dimension should be greater than 160px X 160px");
                    }
