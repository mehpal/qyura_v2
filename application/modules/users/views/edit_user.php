        ...
        <div class="container row">
            ...
            <div style="display:show;" id="consultDiv">
                ...
                <form class="cmxform form-horizontal tasi-form avatar-form" id="submitForm" method="post" action="<?php echo site_url('users/editUserSave'); ?>" novalidate="novalidate" enctype="multipart/form-data">
                    <input type="hidden"  name="users_id" value="<?php if (isset($users_detail->users_id) && !empty($users_detail->users_id)) {
                    echo $users_detail->users_id;
                } ?>" id="users_id"/>
                    <input type="hidden"  name="patientDetails_id" value="<?php if (isset($users_detail->patientDetails_id) && !empty($users_detail->patientDetails_id)) {
                    echo $users_detail->patientDetails_id;
                } ?>" id="users_id"/>
                    <input type="hidden"  name="userInsurance_id" value="<?php if (isset($users_insurance->userInsurance_id) && !empty($users_insurance->userInsurance_id)) {
                    echo $users_insurance->userInsurance_id;
                } ?>" id="userInsurance_id"/>
                    <!-- Left Section Start -->
                            ...
                            <div class="clearfix m-t-20">
                                <article class="form-group m-lr-0 ">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control disabled" id="patientDetails_unqId" name="patientDetails_unqId"  aria-required="true" value="<?php if (isset($users_detail) && !empty($users_detail)) {
                    echo $users_detail->patientDetails_unqId;
...
<?php } ?>
                                                ...
                                                <input type="hidden"  name="patientDetails_patientImg" value="<?php if (isset($users_detail) && !empty($users_detail)) {
    echo $users_detail->patientDetails_patientImg;
} ?>" />
                                ...
                                <article class="form-group m-lr-0">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="patientDetails_patientName" type="text" name="patientDetails_patientName" required="" value="<?php if (isset($users_detail) && !empty($users_detail)) {
                                ...
                                <article class="form-group m-lr-0">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <select class="selectpicker" data-width="100%" name="patientDetails_gender">
                                            ...
                                            <option value="1" <?php if ($users_detail->patientDetails_gender == 1): echo"selected";
endif; ?>>Male</option>
                                            <option value="2" <?php if ($users_detail->patientDetails_gender == 2): echo"selected";
endif; ?>>Female</option>
                                            <option value="3" <?php if ($users_detail->patientDetails_gender == 3): echo"selected";
endif; ?>>Other</option>
                                        </select>
    ...
    echo $newformat = date('d-m-Y', $users_detail->patientDetails_dob);
} ?>">
                                ...
                                <article class="form-group m-lr-0">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="users_email" type="email" name="users_email" placeholder="" value="<?php if (isset($users_detail->users_email) && !empty($users_detail->users_email)) {
    echo $users_detail->users_email;
} ?>">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <aside class="row">
                                            <div class="col-md-12 col-sm-4 col-xs-10 m-t-xs-10 ">
                                                <input type="text" class="form-control" name="patientDetails_mobileNo" id="patientDetails_mobileNo" maxlength="10" placeholder="Number" onkeypress="return isNumberKey(event)" value="<?php if (isset($users_detail) && !empty($users_detail)) {
    echo $users_detail->patientDetails_mobileNo;
} ?>"/>
                                            ...
                                            <div class="col-md-6 col-sm-6 m-t-xs-10">
                                                <select class="selectpicker" data-width="100%" name="patientDetails_stateId" Id="	patientDetails_stateId" data-size="4" onchange ="fetchCity(this.value)">
                                                    ...
                                                    <?php foreach ($allStates as $key => $val) { ?>
                                                        ...
                                                        <option value="<?php echo $val->state_id; ?>" <?php if ($val->state_id == $users_detail->patientDetails_stateId): echo"selected";
                                                    endif; ?>><?php echo $val->state_statename; ?></option>
                                                    <?php } ?>
                                                </select>
...
if (isset($qyura_city) && $qyura_city != NULL) {
    foreach ($qyura_city as $key => $val) {
        ?>
                                                            <option <?php
        if ($users_detail->patientDetails_cityId == $val->city_id) {
            echo "selected";
        }
...
?>
                                            ...
                                            <div class="col-md-6 col-sm-6 m-t-xs-10">
                                                <input type="text" class="form-control" id="patientDetails_pin" name="patientDetails_pin" placeholder="Pin Code" maxlength="6" onkeypress="return isNumberKey(event)" value="<?php if (isset($users_detail) && !empty($users_detail)) {
    echo $users_detail->patientDetails_pin;
} ?>" />
                                ...
                                <article class="form-group m-lr-0 m-t-xs-10">
                                    <div class="col-md-8 col-md-offset-4 col-sm-8 col-sm-offset-4">
                                        <input type="text" class="form-control" id="patientDetails_address" name="patientDetails_address" placeholder=" " value="<?php if (isset($users_detail->patientDetails_address) && !empty($users_detail->patientDetails_address)) {
                                ...
                                <article class="form-group m-lr-0">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        ...
                                        <div class="radio radio-success radio-inline">
                                            ...
                                            <input type="radio" name="healthInsurance1" value="1" id="inlineRadio1" onchange="insuranceShowHide('1', 'insuranceDiv')" <?php if (isset($users_insurance) && !empty($users_insurance)) {
    echo "checked";
} ?> >
                                            <label for="inlineRadio1">Yes</label>
                                        </div>
                                        <div class="radio radio-success radio-inline">
                                            <input type="radio" name="healthInsurance1" value="0" id="inlineRadio2" onchange="insuranceShowHide('0', 'insuranceDiv')" <?php if (!isset($users_insurance) && empty($users_insurance)) {
    echo "checked";
} ?>>
                                ...
                                <div style="display:<?php if (isset($users_insurance) && !empty($users_insurance)) {
    echo 'block';
} else {
    echo 'none';
} ?>" id="insuranceDiv">
...
<?php foreach ($insurance_cmpny as $key => $val) { ?>
                                                    ...
                                                    <option value="<?php echo $val->insurance_id; ?>" <?php if ($val->insurance_id == $users_insurance->userInsurance_insuranceId): echo"selected";
    endif; ?>><?php echo $val->insurance_Name; ?></option>
<?php } ?>
                                            </select>
                                    ...
                                    <article class="form-group m-lr-0">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input class="form-control " id="userInsurance_insuranceNo" type="text" name="userInsurance_insuranceNo"  value="<?php if (isset($users_insurance->userInsurance_insuranceNo) && !empty($users_insurance->userInsurance_insuranceNo)) {
    echo $users_insurance->userInsurance_insuranceNo;
} ?>" />
                                    ...
                                    <article class="form-group m-lr-0">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <div class="input-group">
                                                <input class="form-control pickDate" id="userInsurance_expDate" placeholder="dd/mm/yyyy" id="expiryDate" type="text" name="userInsurance_expDate" onkeydown="return false;" value="<?php if (isset($users_insurance->userInsurance_expDate) && !empty($users_insurance->userInsurance_expDate)) {
    echo date('d-m-Y', $users_insurance->userInsurance_expDate);
} ?>">
...
<?php  if(isset($usersfamily_detail) && !empty($usersfamily_detail)){
foreach ($usersfamily_detail as $key => $val) { ?>
                                             <input type="hidden" id="usersfamily_id" name="usersfamily_id" value="<?php echo $val->usersfamily_id; ?>">
                                                <article class="form-group m-lr-0">
                                                    <label for="" class="control-label col-md-4 col-sm-4">Name :</label>
                                                    <div class="col-md-8 col-sm-8">
                                                        <input class="form-control " id="usersfamily_name_1" type="text" name="usersfamily_name_1" value="<?php echo $val->usersfamily_name; ?>"/>
                                                        ...
                                                        <aside class="row">
                                                            <div class="col-md-6 col-sm-6">
                                                                <select class="selectpicker" data-width="100%" name="usersfamily_gender_1" id="usersfamily_gender_1" required="">
                                                                    <option value="1" <?php if ($val->usersfamily_gender == 1): echo"selected";
    endif; ?> >Male</option>
                                                                    <option value="2" <?php if ($val->usersfamily_gender == 2): echo"selected";
    endif; ?>>Female</option>
                                                            ...
                                                            <div class="col-md-6 col-sm-6 m-t-xs-10">
                                                                <input class="form-control " id="usersfamily_age_1" type="text" name="usersfamily_age_1" required="" value="<?php echo $val->usersfamily_age; ?>" onkeypress="return isNumberKey(event)" placeholder="">
                                                            </div>
                                                        </aside>
                                                    </div>
                                                </article>
                                                ...
                                                <article class="form-group m-lr-0">
                                                    ...
                                                    <div class="col-md-8 col-sm-8">
                                                        <select class="selectpicker" data-width="100%" name="usersfamily_relationId_1" id="usersfamily_relationId_1">
    <?php foreach ($familyMember as $key => $value) { ?>
                                                                <option value="<?php echo $value->relation_id; ?>"<?php if ($value->relation_id == $val->usersfamily_relationId): echo"selected";
        endif; ?>><?php echo $value->relation_type; ?></option>
    <?php } ?>
                                                ...
                                                <article class="form-group m-lr-0">
                                                    ...
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="radio radio-success radio-inline">
                                                            <input type="radio" checked="" name="healthInsurance_1" value="1" id="inlineRadio3_1" onchange="insuranceShowHide('1', 'insuranceDivfamily_1')" <?php if($val->usersfamily_insurance==1) echo 'selected'; ?> >
                                                            <label for="inlineRadio3_1">Yes</label>
                                                        </div>
                                                        <div class="radio radio-success radio-inline">
                                                            <input type="radio" name="healthInsurance_1" value='0' id="inlineRadio4_1" checked onchange="insuranceShowHide('0', 'insuranceDivfamily_1')"  <?php if($val->usersfamily_insurance==0) echo 'selected'; ?>>
                                                            <label for="inlineRadio4_1">No</label>
                                                        </div>
                                                    </div>
                                                </article>

                                                <div style="display:<?php if($val->usersfamily_insurance==1) {echo "block";}else{
                                                    echo 'none';} ?>" id="insuranceDivfamily_1">
                                                    <article class="form-group m-lr-0">
    ...
    foreach ($insurance_cmpny as $key => $value) { ?>
                                                                    <option value="<?php echo $value->insurance_id; ?>"  <?php if ($value->insurance_id == $val->userInsurance_insuranceId){ echo"selected";}
        ?>><?php echo $value->insurance_Name; ?></option>
    <?php }
    } ?>
                                                            </select>
                                                    ...
                                                    <article class="form-group m-lr-0">
                                                        ...
                                                        <div class="col-md-8 col-sm-8">
                                                            <input class="form-control " id="userInsurance_insuranceNo_1" type="text" name="userInsurance_insuranceNo_1" value="<?php echo $val->userInsurance_insuranceNo; ?>" required="" placeholder='HDFC098723' />
