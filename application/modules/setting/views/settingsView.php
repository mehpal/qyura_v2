            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="map_canvas"></div>
                     <form class="cmxform form-horizontal tasi-form avatar-form" id="submitForm" name="submitForm" method="post" action="<?php echo site_url(); ?>/setting/config/<?php echo $this->session->userdata("ses_sa_userid");?>" novalidate="novalidate" enctype="multipart/form-data" >
                        <!-- Left Section Start -->
...
<!--                                             <article class="form-group m-lr-0 ">
                                            ...
                                            <img src="<?php echo base_url()?>assets/patientImages/<?php echo $users[0]->patientDetails_patientImg ?>" width="70" height="65" class="image-preview-show"/>
                                            <label class="error" > <?php echo form_error("sa_img"); ?></label>
                                            <label class="error" > <?php echo $this->session->flashdata('valid_upload'); ?></label>
                                                </div>
                                            </article>-->
